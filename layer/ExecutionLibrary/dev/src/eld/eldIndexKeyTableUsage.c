...
/**
 * @addtogroup eldIndexKeyTableUsage
 * @{
 */

/**
 * @brief Index Key Table Usage Descriptor 를 Dictionary 에 추가한다.
 * @remarks
 * 함수 ellInsertIndexKeyTableUsageDesc() 주석 참조 
 */
                                           ...
                                           ellEnv         * aEnv )
{
    ...
    STL_TRY( eldSetColumnValue( ELDT_TABLE_ID_INDEX_KEY_TABLE_USAGE,
    ...
    STL_TRY( smlInsertRecord( aStmt,
                              gEldTablePhysicalHandle[ELDT_TABLE_ID_INDEX_KEY_TABLE_USAGE],
                              sDataValueList,
