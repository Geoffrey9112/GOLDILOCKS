 ...
 * @remarks
 * 함수 ellInsertCheckTableUsageDesc() 주석 참조 
 */
                                        ...
                                        ellEnv         * aEnv )
{
     ...
     */
    STL_TRY( eldAllocTableValueList( ELDT_TABLE_ID_CHECK_TABLE_USAGE,
                                     & sMemMark,
                                     & sDataValueList,
                                     aEnv )
             == STL_SUCCESS );
    ...
    STL_TRY( eldSetColumnValue( ELDT_TABLE_ID_CHECK_TABLE_USAGE,
    ...
    STL_TRY( smlInsertRecord( aStmt,
                              gEldTablePhysicalHandle[ELDT_TABLE_ID_CHECK_TABLE_USAGE],
                              sDataValueList,
