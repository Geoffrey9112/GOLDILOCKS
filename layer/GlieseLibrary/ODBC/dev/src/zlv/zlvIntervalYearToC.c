...
/**
 * @file zlvCharToC.c
 * @brief Gliese API Internal Converting Data from SQL Interval Year to C Data Types Routines.
 */

/**
 * @addtogroup zlvIntervalYearToC
 * @{
 */
...
/*
 * SQL_INTERVAL_YEAR -> SQL_C_INTERVAL_MONTH
 */
ZLV_DECLARE_SQL_TO_C( IntervalYear, IntervalMonth )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    sTarget->intval.year_month.month = sYear * 12;
...
/*
 * SQL_INTERVAL_YEAR -> SQL_C_INTERVAL_YEAR_TO_MONTH
 */
...
/*
 * SQL_INTERVAL_YEAR -> SQL_C_STINYINT
 */
ZLV_DECLARE_SQL_TO_C( IntervalYear, STinyInt )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY_THROW( ( (stlInt32)sYear >= STL_INT8_MIN ) &&
                   ( (stlInt32)sYear <= STL_INT8_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    if( sIsNegative == STL_FALSE )
    {
        *sTarget = (stlInt8)sYear;
    }
    else
    {
        *sTarget = -(stlInt8)sYear;
...
/*
 * SQL_INTERVAL_YEAR -> SQL_C_UTINYINT
 */
ZLV_DECLARE_SQL_TO_C( IntervalYear, UTinyInt )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY_THROW( ( sYear >= STL_UINT8_MIN ) &&
                   ( sYear <= STL_UINT8_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    *sTarget = (stlUInt8)sYear;
...
/*
 * SQL_INTERVAL_YEAR -> SQL_C_SBIGINT
 */
...
/*
 * SQL_INTERVAL_YEAR -> SQL_C_UBIGINT
 */
...
/*
 * SQL_INTERVAL_YEAR -> SQL_C_SSHORT
 */
ZLV_DECLARE_SQL_TO_C( IntervalYear, SShort )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY_THROW( ( (stlInt32)sYear >= STL_INT16_MIN ) &&
                   ( (stlInt32)sYear <= STL_INT16_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    if( sIsNegative == STL_FALSE )
    {
        *sTarget = (stlInt16)sYear;
    }
    else
    {
        *sTarget = -(stlInt16)sYear;
...
/*
 * SQL_INTERVAL_YEAR -> SQL_C_USHORT
 */
ZLV_DECLARE_SQL_TO_C( IntervalYear, UShort )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY_THROW( ( sYear >= STL_UINT16_MIN ) &&
                   ( sYear <= STL_UINT16_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    *sTarget = (stlUInt16)sYear;
...
ZLV_DECLARE_SQL_TO_C( IntervalYear, SLong )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY_THROW( ( (stlInt32)sYear >= STL_INT32_MIN ) &&
                   ( (stlInt32)sYear <= STL_INT32_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    if( sIsNegative == STL_FALSE )
    {
        *sTarget = (stlInt32)sYear;
    }
    else
    {
        *sTarget = -(stlInt32)sYear;
...
/*
 * SQL_INTERVAL_YEAR -> SQL_C_NUMERIC
 */
ZLV_DECLARE_SQL_TO_C( IntervalYear, Numeric )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY( zlvMakeCNumericFromInteger( aStmt,
                                         ...
                                         sYear,
                                         aArdRec->mScale,
                                         ZLV_INTERVAL_YEAR_TO_C_NUMERIC_PRECISION,
                                         sIsNegative,
                                         aErrorStack )
             == STL_SUCCESS );
...
/*
 * SQL_INTERVAL_YEAR -> SQL_C_BINARY
 */
...
/*
 * SQL_INTERVAL_YEAR -> SQL_C_LONGVARBINARY
 */
...
/*
 * SQL_INTERVAL_YEAR -> SQL_C_LONGVARCHAR
 */
