...
/**
 * @file zlvCharToC.c
 * @brief Gliese API Internal Converting Data from SQL Interval Second to C Data Types Routines.
 */

/**
 * @addtogroup zlvIntervalSecondToC
 * @{
 */
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_INTERVAL_DAY
 */
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_INTERVAL_HOUR
 */
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_INTERVAL_MINUTE
 */
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_INTERVAL_DAY_TO_HOUR
 */
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_INTERVAL_DAY_TO_MINUTE
 */
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_INTERVAL_DAY_TO_SECOND
 */
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_INTERVAL_HOUR_TO_MINUTE
 */
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_INTERVAL_HOUR_TO_SECOND
 */
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_INTERVAL_MINUTE_TO_SECOND
 */
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_STINYINT
 */
ZLV_DECLARE_SQL_TO_C( IntervalSecond, STinyInt )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    sTotalSecond = ( ( ( ( ( sDay * 24 ) + sHour ) * 60 ) + sMinute ) * 60 ) + sSecond;

    STL_TRY_THROW( ( sTotalSecond >= STL_INT8_MIN ) &&
                   ( sTotalSecond <= STL_INT8_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    if( sIsNegative == STL_FALSE )
    {
        *sTarget = (stlInt8)sTotalSecond;
    }
    else
    {
        *sTarget = -(stlInt8)sTotalSecond;
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_UTINYINT
 */
ZLV_DECLARE_SQL_TO_C( IntervalSecond, UTinyInt )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY_THROW( ( sTotalSecond >= STL_UINT8_MIN ) &&
                   ( sTotalSecond <= STL_UINT8_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    *sTarget = (stlUInt8)sTotalSecond;
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_SBIGINT
 */
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_UBIGINT
 */
ZLV_DECLARE_SQL_TO_C( IntervalSecond, UBigInt )
{
    ...
    *sTarget = (stlUInt64)sTotalSecond;
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_SSHORT
 */
ZLV_DECLARE_SQL_TO_C( IntervalSecond, SShort )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY_THROW( ( sTotalSecond >= STL_INT16_MIN ) &&
                   ( sTotalSecond <= STL_INT16_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    if( sIsNegative == STL_FALSE )
    {
        *sTarget = (stlInt16)sTotalSecond;
    }
    else
    {
        *sTarget = -(stlInt16)sTotalSecond;
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_USHORT
 */
ZLV_DECLARE_SQL_TO_C( IntervalSecond, UShort )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY_THROW( ( sTotalSecond >= STL_UINT16_MIN ) &&
                   ( sTotalSecond <= STL_UINT16_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    *sTarget = (stlUInt16)sTotalSecond;
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_SLONG
 */
ZLV_DECLARE_SQL_TO_C( IntervalSecond, SLong )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY_THROW( ( sTotalSecond >= STL_INT32_MIN ) &&
                   ( sTotalSecond <= STL_INT32_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    if( sIsNegative == STL_FALSE )
    {
        *sTarget = (stlInt32)sTotalSecond;
    }
    else
    {
        *sTarget = -(stlInt32)sTotalSecond;
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_ULONG
 */
ZLV_DECLARE_SQL_TO_C( IntervalSecond, ULong )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY_THROW( ( sTotalSecond >= STL_UINT32_MIN ) &&
                   ( sTotalSecond <= STL_UINT32_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    *sTarget = (stlUInt32)sTotalSecond;
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_NUMERIC
 */
ZLV_DECLARE_SQL_TO_C( IntervalSecond, Numeric )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY( zlvMakeCNumericFromSecond( aStmt,
                                        sTarget,
                                        sTotalSecond,
                                        sFraction,
                                        aArdRec->mScale,
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_BINARY
 */
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_LONGVARBINARY
 */
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_CHAR
 */
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_WCHAR
 */
...
/*
 * SQL_INTERVAL_SECOND -> SQL_C_LONGVARCHAR
 */
