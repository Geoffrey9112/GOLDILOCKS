...
/**
 * @file zlvCSBigIntToSql.c
 * @brief Gliese API Internal Converting Data from C Signed Big Integer to SQL Data Types Routines.
 */

/**
 * @addtogroup zlvCSBigIntToSql
 * @{
 */
...
ZLV_DECLARE_C_TO_SQL( SBigInt, Char )
{
    ...
    sParameter = (stlInt64*)aParameterValuePtr;

    STL_TRY( dtlCharSetValueFromIntegerWithoutPaddNull( *sParameter,
                                                        aIpdRec->mLength,
                                                        DTL_SCALE_NA,
                                                        DTL_STRING_LENGTH_UNIT_OCTETS,
                                                        DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( SBigInt, VarChar )
{
    ...
    STL_TRY( dtlVarcharSetValueFromInteger( *sParameter,
                                            aIpdRec->mLength,
                                            DTL_SCALE_NA,
                                            DTL_STRING_LENGTH_UNIT_OCTETS,
                                            DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( SBigInt, LongVarChar )
{
    ...
    STL_TRY( dtlLongvarcharSetValueFromInteger( *sParameter,
                                                aIpdRec->mLength,
                                                DTL_SCALE_NA,
                                                DTL_STRING_LENGTH_UNIT_OCTETS,
                                                DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( SBigInt, Float )
{
    ...
    STL_TRY( dtlFloatSetValueFromInteger( *(stlInt64*)aParameterValuePtr,
                                          aIpdRec->mPrecision,
                                          DTL_SCALE_NA,
                                          DTL_STRING_LENGTH_UNIT_NA,
                                          DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( SBigInt, Numeric )
{
    ...
    STL_TRY( dtlNumericSetValueFromInteger( *(stlInt64*)aParameterValuePtr,
                                            aIpdRec->mPrecision,
                                            aIpdRec->mScale,
                                            DTL_STRING_LENGTH_UNIT_NA,
                                            DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( SBigInt, BigInt )
{
    ...
    STL_TRY( dtlBigIntSetValueFromInteger( *(stlInt64*)aParameterValuePtr,
                                           DTL_PRECISION_NA,
                                           DTL_SCALE_NA,
                                           DTL_STRING_LENGTH_UNIT_NA,
                                           DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( SBigInt, Real )
{
    ...
    STL_TRY( dtlRealSetValueFromInteger( *(stlInt64*)aParameterValuePtr,
                                         DTL_PRECISION_NA,
                                         DTL_SCALE_NA,
                                         DTL_STRING_LENGTH_UNIT_NA,
                                         DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( SBigInt, Double )
{
    ...
    STL_TRY( dtlDoubleSetValueFromInteger( *(stlInt64*)aParameterValuePtr,
                                           DTL_PRECISION_NA,
                                           DTL_SCALE_NA,
                                           DTL_STRING_LENGTH_UNIT_NA,
                                           DTL_INTERVAL_INDICATOR_NA,
...
/*
 * SQL_C_SBIGINT -> SQL_BOOLEAN
 */
ZLV_DECLARE_C_TO_SQL( SBigInt, Boolean )
{
    return zlvCSBigIntToSqlBit( aStmt,
                                aParameterValuePtr,
                                aIndicator,
                                aApdRec,
                                aIpdRec,
...
/*
 * SQL_C_SBIGINT -> SQL_INTERVAL_YEAR
 */
...
/*
 * SQL_C_SBIGINT -> SQL_INTERVAL_MONTH
 */
...
/*
 * SQL_C_SBIGINT -> SQL_INTERVAL_DAY
 */
...
/*
 * SQL_C_SBIGINT -> SQL_INTERVAL_HOUR
 */
...
/*
 * SQL_C_SBIGINT -> SQL_INTERVAL_MINUTE
 */
...
/*
 * SQL_C_SBIGINT -> SQL_INTERVAL_SECOND
 */
