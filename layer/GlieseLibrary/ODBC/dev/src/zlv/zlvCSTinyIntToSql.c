...
/**
 * @file zlvCSTinyIntToSql.c
 * @brief Gliese API Internal Converting Data from C Signed Tiny Integer to SQL Data Types Routines.
 */

/**
 * @addtogroup zlvCSTinyIntToSql
 * @{
 */
...
/*
 * SQL_C_STINYINT -> SQL_LONGVARCHAR
 */
...
ZLV_DECLARE_C_TO_SQL( STinyInt, Float )
{
    ...
    STL_TRY( dtlFloatSetValueFromInteger( *(stlInt8*)aParameterValuePtr,
                                          aIpdRec->mPrecision,
                                          DTL_SCALE_NA,
                                          DTL_STRING_LENGTH_UNIT_NA,
                                          DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( STinyInt, Numeric )
{
    ...
    STL_TRY( dtlNumericSetValueFromInteger( *(stlInt8*)aParameterValuePtr,
                                            aIpdRec->mPrecision,
                                            aIpdRec->mScale,
                                            DTL_STRING_LENGTH_UNIT_NA,
                                            DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( STinyInt, Integer )
{
    ...
    STL_TRY( dtlIntegerSetValueFromInteger( *(stlInt8*)aParameterValuePtr,
                                            DTL_PRECISION_NA,
                                            DTL_SCALE_NA,
                                            DTL_STRING_LENGTH_UNIT_NA,
                                            DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( STinyInt, BigInt )
{
    ...
    STL_TRY( dtlBigIntSetValueFromInteger( *(stlInt8*)aParameterValuePtr,
                                           DTL_PRECISION_NA,
                                           DTL_SCALE_NA,
                                           DTL_STRING_LENGTH_UNIT_NA,
                                           DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( STinyInt, Real )
{
    ...
    STL_TRY( dtlRealSetValueFromInteger( *(stlInt8*)aParameterValuePtr,
                                         DTL_PRECISION_NA,
                                         DTL_SCALE_NA,
                                         DTL_STRING_LENGTH_UNIT_NA,
                                         DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( STinyInt, Double )
{
    ...
    STL_TRY( dtlDoubleSetValueFromInteger( *(stlInt8*)aParameterValuePtr,
                                           DTL_PRECISION_NA,
                                           DTL_SCALE_NA,
                                           DTL_STRING_LENGTH_UNIT_NA,
                                           DTL_INTERVAL_INDICATOR_NA,
...
/*
 * SQL_C_STINYINT -> SQL_BOOLEAN
 */
ZLV_DECLARE_C_TO_SQL( STinyInt, Boolean )
{
    return zlvCSTinyIntToSqlBit( aStmt,
                                 aParameterValuePtr,
                                 aIndicator,
                                 aApdRec,
                                 aIpdRec,
...
/*
 * SQL_C_STINYINT -> SQL_INTERVAL_YEAR
 */
...
/*
 * SQL_C_STINYINT -> SQL_INTERVAL_MONTH
 */
...
/*
 * SQL_C_STINYINT -> SQL_INTERVAL_DAY
 */
...
/*
 * SQL_C_STINYINT -> SQL_INTERVAL_HOUR
 */
...
/*
 * SQL_C_STINYINT -> SQL_INTERVAL_MINUTE
 */
...
/*
 * SQL_C_STINYINT -> SQL_INTERVAL_SECOND
 */
