...
/**
 * @file zlvCharToC.c
 * @brief Gliese API Internal Converting Data from SQL Interval Minute to C Data Types Routines.
 */

/**
 * @addtogroup zlvIntervalMinuteToC
 * @{
 */
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_INTERVAL_DAY
 */
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_INTERVAL_HOUR
 */
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_INTERVAL_DAY_TO_HOUR
 */
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_INTERVAL_DAY_TO_MINUTE
 */
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_INTERVAL_DAY_TO_SECOND
 */
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_INTERVAL_HOUR_TO_MINUTE
 */
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_INTERVAL_HOUR_TO_SECOND
 */
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_INTERVAL_MINUTE_TO_SECOND
 */
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_STINYINT
 */
ZLV_DECLARE_SQL_TO_C( IntervalMinute, STinyInt )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    sTotalMinute = ( ( ( sDay * 24 ) + sHour ) * 60 ) + sMinute;

    STL_TRY_THROW( ( sTotalMinute >= STL_INT8_MIN ) &&
                   ( sTotalMinute <= STL_INT8_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    if( sIsNegative == STL_FALSE )
    {
        *sTarget = (stlInt8)sTotalMinute;
    }
    else
    {
        *sTarget = -(stlInt8)sTotalMinute;
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_UTINYINT
 */
ZLV_DECLARE_SQL_TO_C( IntervalMinute, UTinyInt )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY_THROW( ( sTotalMinute >= STL_UINT8_MIN ) &&
                   ( sTotalMinute <= STL_UINT8_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    *sTarget = (stlUInt8)sTotalMinute;
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_SBIGINT
 */
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_UBIGINT
 */
ZLV_DECLARE_SQL_TO_C( IntervalMinute, UBigInt )
{
    ...
    *sTarget = (stlUInt64)sTotalMinute;
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_SSHORT
 */
ZLV_DECLARE_SQL_TO_C( IntervalMinute, SShort )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY_THROW( ( sTotalMinute >= STL_INT16_MIN ) &&
                   ( sTotalMinute <= STL_INT16_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    if( sIsNegative == STL_FALSE )
    {
        *sTarget = (stlInt16)sTotalMinute;
    }
    else
    {
        *sTarget = -(stlInt16)sTotalMinute;
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_USHORT
 */
ZLV_DECLARE_SQL_TO_C( IntervalMinute, UShort )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY_THROW( ( sTotalMinute >= STL_UINT16_MIN ) &&
                   ( sTotalMinute <= STL_UINT16_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    *sTarget = (stlUInt16)sTotalMinute;
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_SLONG
 */
ZLV_DECLARE_SQL_TO_C( IntervalMinute, SLong )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY_THROW( ( sTotalMinute >= STL_INT32_MIN ) &&
                   ( sTotalMinute <= STL_INT32_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    if( sIsNegative == STL_FALSE )
    {
        *sTarget = (stlInt32)sTotalMinute;
    }
    else
    {
        *sTarget = -(stlInt32)sTotalMinute;
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_ULONG
 */
ZLV_DECLARE_SQL_TO_C( IntervalMinute, ULong )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY_THROW( ( sTotalMinute >= STL_UINT32_MIN ) &&
                   ( sTotalMinute <= STL_UINT32_MAX ),
                   RAMP_ERR_NUMERIC_VALUE_OUT_OF_RANGE );

    *sTarget = (stlUInt32)sTotalMinute;
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_NUMERIC
 */
ZLV_DECLARE_SQL_TO_C( IntervalMinute, Numeric )
{
    ...
    *aReturn = SQL_ERROR;
    ...
    STL_TRY( zlvMakeCNumericFromInteger( aStmt,
                                         ...
                                         sTotalMinute,
                                         aArdRec->mScale,
                                         ZLV_INTERVAL_MINUTE_TO_C_NUMERIC_PRECISION,
                                         sIsNegative,
                                         aErrorStack )
             == STL_SUCCESS );
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_BINARY
 */
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_LONGVARBINARY
 */
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_CHAR
 */
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_WCHAR
 */
...
/*
 * SQL_INTERVAL_MINUTE -> SQL_C_LONGVARCHAR
 */
