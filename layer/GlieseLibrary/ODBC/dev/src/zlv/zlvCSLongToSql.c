...
/**
 * @file zlvCSLongToSql.c
 * @brief Gliese API Internal Converting Data from C Signed Integer to SQL Data Types Routines.
 */

/**
 * @addtogroup zlvCSLongToSql
 * @{
 */
...
ZLV_DECLARE_C_TO_SQL( SLong, Char )
{
    ...
    sParameter = (stlInt32*)aParameterValuePtr;
...
ZLV_DECLARE_C_TO_SQL( SLong, Float )
{
    ...
    STL_TRY( dtlFloatSetValueFromInteger( *(stlInt32*)aParameterValuePtr,
                                          aIpdRec->mPrecision,
                                          DTL_SCALE_NA,
                                          DTL_STRING_LENGTH_UNIT_NA,
                                          DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( SLong, Numeric )
{
    ...
    STL_TRY( dtlNumericSetValueFromInteger( *(stlInt32*)aParameterValuePtr,
                                            aIpdRec->mPrecision,
                                            aIpdRec->mScale,
                                            DTL_STRING_LENGTH_UNIT_NA,
                                            DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( SLong, Integer )
{
    ...
    STL_TRY( dtlIntegerSetValueFromInteger( *(stlInt32*)aParameterValuePtr,
                                            DTL_PRECISION_NA,
                                            DTL_SCALE_NA,
                                            DTL_STRING_LENGTH_UNIT_NA,
                                            DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( SLong, BigInt )
{
    ...
    STL_TRY( dtlBigIntSetValueFromInteger( *(stlInt32*)aParameterValuePtr,
                                           DTL_PRECISION_NA,
                                           DTL_SCALE_NA,
                                           DTL_STRING_LENGTH_UNIT_NA,
                                           DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( SLong, Real )
{
    ...
    STL_TRY( dtlRealSetValueFromInteger( *(stlInt32*)aParameterValuePtr,
                                         DTL_PRECISION_NA,
                                         DTL_SCALE_NA,
                                         DTL_STRING_LENGTH_UNIT_NA,
                                         DTL_INTERVAL_INDICATOR_NA,
...
ZLV_DECLARE_C_TO_SQL( SLong, Double )
{
    ...
    STL_TRY( dtlDoubleSetValueFromInteger( *(stlInt32*)aParameterValuePtr,
                                           DTL_PRECISION_NA,
                                           DTL_SCALE_NA,
                                           DTL_STRING_LENGTH_UNIT_NA,
                                           DTL_INTERVAL_INDICATOR_NA,
...
/*
 * SQL_C_SLONG -> SQL_BOOLEAN
 */
ZLV_DECLARE_C_TO_SQL( SLong, Boolean )
{
    return zlvCSLongToSqlBit( aStmt,
                              aParameterValuePtr,
                              aIndicator,
                              aApdRec,
                              aIpdRec,
...
/*
 * SQL_C_SLONG -> SQL_INTERVAL_MONTH
 */
...
/*
 * SQL_C_SLONG -> SQL_INTERVAL_MINUTE
 */
...
/*
 * SQL_C_SLONG -> SQL_INTERVAL_SECOND
 */
