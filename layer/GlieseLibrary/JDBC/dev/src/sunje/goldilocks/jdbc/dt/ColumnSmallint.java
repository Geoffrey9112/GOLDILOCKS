...
public class ColumnSmallint extends ColumnNonDateTime
{
    private short mValue = 0;
    
    ColumnSmallint(CodeColumn aCode)
    {
        super(aCode);
    }
    ...
    protected void setStringImpl(String aValue) throws SQLException
    {
        try
        {
            mValue = Short.parseShort(aValue);
        }
    ...
    protected void setObjectImpl(Object aValue) throws SQLException
    {
        ...
        {
            mValue = ((Number)aValue).shortValue();
        }
        else
        {
