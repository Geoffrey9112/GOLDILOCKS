...
public class ColumnIntervalDayToHour extends ColumnIntervalDayTimeCommon
{
    ColumnIntervalDayToHour(CodeColumn aCode)
    {
        super(aCode);
    }
    ...
    {
        setDayTime(GoldilocksInterval.createIntervalDayToHour((int)mPrecision, aValue));
    }
    ...
    {
        return GoldilocksInterval.createIntervalDayToHour((int)mPrecision, getSign(), getDay(), getHour()).toString();
    }

    protected Object getObjectImpl() throws SQLException
    {
        return GoldilocksInterval.createIntervalDayToHour((int)mPrecision, getSign(), getDay(), getHour());
    }
