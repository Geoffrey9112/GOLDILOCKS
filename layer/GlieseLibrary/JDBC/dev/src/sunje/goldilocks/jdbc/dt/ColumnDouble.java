...
public class ColumnDouble extends ColumnNonDateTime
{
    private double mValue = 0;
    
    ColumnDouble(CodeColumn aCode)
    {
        super(aCode);
    }
    ...
    {
        mValue = mCache.readDouble(mId);
    }
    
    protected void storeValueToCursorImpl() throws SQLException
    {
        mCache.writeDouble(mId, mValue);
    }
    ...
    protected void setStringImpl(String aValue) throws SQLException
    {
        try
        {
            mValue = Double.parseDouble(aValue);
        }
