...
public class ColumnIntervalDayToMinute extends ColumnIntervalDayTimeCommon
{
    ColumnIntervalDayToMinute(CodeColumn aCode)
    {
        super(aCode);
    }
    ...
    {
        setDayTime(GoldilocksInterval.createIntervalDayToMinute((int)mPrecision, aValue));
    }
    ...
    {
        return GoldilocksInterval.createIntervalDayToMinute((int)mPrecision, getSign(), getDay(), getHour(), getMinute()).toString();
    }

    protected Object getObjectImpl() throws SQLException
    {
        return GoldilocksInterval.createIntervalDayToMinute((int)mPrecision, getSign(), getDay(), getHour(), getMinute());
    }
