...
public class ColumnIntervalHourToMinute extends ColumnIntervalDayTimeCommon
{
    ColumnIntervalHourToMinute(CodeColumn aCode)
    {
        super(aCode);
    }
    ...
    {
        setDayTime(GoldilocksInterval.createIntervalHourToMinute((int)mPrecision, aValue));
    }
    ...
    {
        return GoldilocksInterval.createIntervalHourToMinute((int)mPrecision, getSign(), getDay(), getHour(), getMinute()).toString();
    }

    protected Object getObjectImpl() throws SQLException
    {
        return GoldilocksInterval.createIntervalHourToMinute((int)mPrecision, getSign(), getDay(), getHour(), getMinute());
    }
