...
public class ColumnIntervalHourToSecond extends ColumnIntervalDayTimeCommon
{
    ColumnIntervalHourToSecond(CodeColumn aCode)
    {
        super(aCode);
    }
    ...
    {
        setDayTime(GoldilocksInterval.createIntervalHourToSecond((int)mPrecision, (int)mScale, aValue));
    }
    ...
    {
        return GoldilocksInterval.createIntervalHourToSecond((int)mPrecision, (int)mScale, getSign(), getDay(), getHour(), getMinute(), getSecond(), getMicroSec()).toString();
    }

    protected Object getObjectImpl() throws SQLException
    {
        return GoldilocksInterval.createIntervalHourToSecond((int)mPrecision, (int)mScale, getSign(), getDay(), getHour(), getMinute(), getSecond(), getMicroSec());
    }
