...
public class ColumnIntervalDayToSecond extends ColumnIntervalDayTimeCommon
{
    ColumnIntervalDayToSecond(CodeColumn aCode)
    {
        super(aCode);
    }
    ...
    {
        setDayTime(GoldilocksInterval.createIntervalDayToSecond((int)mPrecision, (int)mScale, aValue));
    }
    ...
    {
        return GoldilocksInterval.createIntervalDayToSecond((int)mPrecision, (int)mScale, getSign(), getDay(), getHour(), getMinute(), getSecond(), getMicroSec()).toString();
    }

    protected Object getObjectImpl() throws SQLException
    {
        return GoldilocksInterval.createIntervalDayToSecond((int)mPrecision, (int)mScale, getSign(), getDay(), getHour(), getMinute(), getSecond(), getMicroSec());
    }
