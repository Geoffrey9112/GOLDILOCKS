...
set(_JAVA_SYMLINK_SCRIPT ${CMAKE_CURRENT_SOURCE_DIR}/UseJavaSymlinks.cmake)

function(add_jar _TARGET_NAME _TARGET_PATH)
    ...
    set(_JAVA_TARGET_OUTPUT_NAME "${_TARGET_PATH}/${_TARGET_NAME}.jar")
    ...
    if (_JAVA_COMPILE_FILES)
        ...
        add_custom_command(
            ...
            ARGS    ${CMAKE_CURRENT_SOURCE_DIR}/${CMAKE_JAVA_MANIFEST_FILE}
                    ${CMAKE_JAVA_CLASS_OUTPUT_PATH}/${CMAKE_JAVA_MANIFEST_FILE}
            DEPENDS ${CMAKE_CURRENT_SOURCE_DIR}/${CMAKE_JAVA_MANIFEST_FILE}
            COMMAND ${CMAKE_COMMAND} -E copy_if_different
            ARGS    ${CMAKE_CURRENT_SOURCE_DIR}/${CMAKE_JAVA_RESOURCE_FILE}
                    ${CMAKE_JAVA_CLASS_OUTPUT_PATH}/${CMAKE_JAVA_RESOURCE_FILE}
            DEPENDS ${CMAKE_CURRENT_SOURCE_DIR}/${CMAKE_JAVA_RESOURCE_FILE}
    ...
    if (CMAKE_JNI_TARGET)
        add_custom_command(
            OUTPUT ${_JAVA_TARGET_OUTPUT_NAME}
            COMMAND ${Java_JAR_EXECUTABLE}
                -cfm ${CMAKE_CURRENT_BINARY_DIR}/${_JAVA_TARGET_OUTPUT_NAME} ${CMAKE_JAVA_MANIFEST_FILE}
                ${_JAVA_RESOURCE_FILES} @java_class_filelist ${CMAKE_JAVA_RESOURCE_FILE}
            COMMAND ${CMAKE_COMMAND}
        ...
        add_custom_command(
            OUTPUT ${_JAVA_TARGET_OUTPUT_NAME}
            COMMAND ${Java_JAR_EXECUTABLE}
                -cfm ${_JAVA_TARGET_OUTPUT_NAME} ${CMAKE_JAVA_MANIFEST_FILE}
                ${_JAVA_RESOURCE_FILES} @java_class_filelist ${CMAKE_JAVA_RESOURCE_FILE}
            COMMAND ${CMAKE_COMMAND}
                -D_JAVA_TARGET_DIR=${CMAKE_CURRENT_BINARY_DIR}
                -D_JAVA_TARGET_OUTPUT_NAME=${_JAVA_TARGET_OUTPUT_NAME}
    ...
    add_custom_target(${_TARGET_NAME} ALL DEPENDS ${_JAVA_TARGET_OUTPUT_NAME})
