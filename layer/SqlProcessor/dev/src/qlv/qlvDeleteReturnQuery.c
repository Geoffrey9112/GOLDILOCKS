...
/**
 * @addtogroup qlvDeleteReturnQuery
 * @{
 */


/**
 * @brief DELETE RETURNING Query 구문을 Validation 한다.
                                        ...
                                        qllEnv        * aEnv )
{
    ...
    STL_PARAM_VALIDATE( aParseTree->mType == QLL_STMT_DELETE_RETURNING_QUERY_TYPE,
                        QLL_ERROR_STACK(aEnv) );

    /**
     * 기본 DELETE Validation
     */
    ...
    /**
     * DELETE RETURNING Query 의 Result Set Property 결정
     */
