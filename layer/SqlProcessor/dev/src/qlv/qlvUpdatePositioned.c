...
/**
 * @file qlvUpdatePositioned.c
 * @brief SQL Processor Layer : Validation of UPDATE CURRENT OF statement
 */
...
/**
 * @addtogroup qlvUpdatePositioned
 * @{
 */


/**
 * @brief UPDATE CURRENT OF 구문을 Validation 한다.
                                       ...
                                       qllEnv        * aEnv )
{
    ...
    STL_PARAM_VALIDATE( aParseTree->mType == QLL_STMT_UPDATE_WHERE_CURRENT_OF_TYPE,
                        QLL_ERROR_STACK(aEnv) );
    ...
    sInitPlan = (qlvInitUpdate *) aSQLStmt->mInitPlan;
