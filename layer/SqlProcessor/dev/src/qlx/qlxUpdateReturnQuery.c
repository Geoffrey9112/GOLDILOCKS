...
/**
 * @file qlxUpdateReturnQuery.c
 * @brief SQL Processor Layer : Execution of UPDATE RETURNING Query statement
 */
...
/**
 * @addtogroup qlxUpdateReturnQuery
 * @{
 */


/**
 * @brief UPDATE RETURNING Query 구문을 실행한다.
