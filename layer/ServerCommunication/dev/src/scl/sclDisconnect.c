...
/**
 * @brief Disconnect Command Protocol을 읽는다.
                                    ...
                                    sclEnv          * aEnv )
{
    ...
    SCP_READ_INT8( aHandle, &sCursor, &sPeriod, aEnv );

    STL_DASSERT( sCommandType == CML_COMMAND_DISCONNECT );
...
/**
 * @brief Disconnect Result Protocol을 기록한다.
 * @param[in] aHandle        Communication Handle
...
{
    scpCursor    sCursor;
    stlInt16     sResultType = CML_COMMAND_DISCONNECT;
