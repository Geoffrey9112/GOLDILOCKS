...
/**
 * @file dtcFromVarbinary.c
 * @brief DataType Layer Varbinary으로부터 다른 타입으로의 변환 
 */
...
/**
 * @ingroup dtcFromVarbinary
 * @{
 */

/**
 * @brief Varbinary -> Binary 으로의 type cast
...
//  sDestIntervalIndicatorValue  = aInputArgument[4].mValue.mDataValue;
    ...
    DTF_CHECK_DTL_VALUE( sSourceValue, DTL_TYPE_VARBINARY, sErrorStack );
...
/**
 * @brief Varbinary -> Varbinary 으로의 type cast
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
 * @param[out] aResultValue      cast연산결과
 * @param[in,out]  aInfo         function 수행에 필요한 부가 정보
...
/**
 * @brief Varbinary -> Longvarbinary 으로의 type cast
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
 * @param[out] aResultValue      cast연산결과
 * @param[in,out]  aInfo         function 수행에 필요한 부가 정보
