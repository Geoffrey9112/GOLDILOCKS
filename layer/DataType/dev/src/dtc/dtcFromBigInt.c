...
/**
 * @file dtcFromBigInt.c
 * @brief DataType Layer BigInt으로부터 다른 타입으로의 변환 
 */
...
/**
 * @ingroup dtcFromBigInt
 * @{
 */

/**
 * @brief BigInt -> SmallInt 으로의 type cast
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
 *                          <BR> aSrcValue      cast 대상이 되는 dtlDataValue
 ...
 */
stlStatus dtcCastBigIntToSmallInt( stlUInt16        aInputArgumentCnt,
...
/**
 * @brief BigInt -> Integer 으로의 type cast
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
 *                          <BR> aSrcValue      cast 대상이 되는 dtlDataValue
 * @param[out] aResultValue      cast연산결과
 ...
 * @param[out] aEnv              environment (stlErrorStack) 
 */
stlStatus dtcCastBigIntToInteger( stlUInt16        aInputArgumentCnt,
                                  dtlValueEntry  * aInputArgument,
                                  void           * aResultValue,
                                  void           * aInfo,
                                  dtlFuncVector  * aVectorFunc,
...
/**
 * @brief BigInt -> BigInt 으로의 type cast
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
 *                          <BR> aSrcValue      cast 대상이 되는 dtlDataValue
 * @param[out] aResultValue      cast연산결과
 ...
 * @param[out] aEnv              environment (stlErrorStack) 
 */
stlStatus dtcCastBigIntToBigInt( stlUInt16        aInputArgumentCnt,
                                 dtlValueEntry  * aInputArgument,
                                 void           * aResultValue,
                                 void           * aInfo,
                                 dtlFuncVector  * aVectorFunc,
...
//  sDestIntervalIndicatorValue  = aInputArgument[4].mValue.mDataValue;
    ...
    DTF_CHECK_DTL_VALUE( sSourceValue, DTL_TYPE_NATIVE_BIGINT, (stlErrorStack *)aEnv );
     ...
     */
    *(dtlBigIntType *)(sResultValue->mValue) = *(dtlBigIntType *)sSourceValue->mValue;
...
/**
 * @brief BigInt -> Real 으로의 type cast
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
 *                          <BR> aSrcValue      cast 대상이 되는 dtlDataValue
 * @param[out] aResultValue      cast연산결과
 ...
 * @param[out] aEnv              environment (stlErrorStack) 
 */
stlStatus dtcCastBigIntToReal( stlUInt16        aInputArgumentCnt,
                               dtlValueEntry  * aInputArgument,
                               void           * aResultValue,
                               void           * aInfo,
                               dtlFuncVector  * aVectorFunc,
...
/**
 * @brief BigInt -> Double 으로의 type cast
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
 *                          <BR> aSrcValue      cast 대상이 되는 dtlDataValue
 * @param[out] aResultValue      cast연산결과
 ...
 * @param[out] aEnv              environment (stlErrorStack) 
 */
stlStatus dtcCastBigIntToDouble( stlUInt16        aInputArgumentCnt,
                                 dtlValueEntry  * aInputArgument,
                                 void           * aResultValue,
                                 void           * aInfo,
                                 dtlFuncVector  * aVectorFunc,
...
/**
 * @brief BigInt -> Numeric 으로의 type cast
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
 * @param[out] aResultValue      cast연산결과
 * @param[in,out]  aInfo         function 수행에 필요한 부가 정보
 ...
 * @param[out] aEnv              environment (stlErrorStack) 
 */
stlStatus dtcCastBigIntToNumeric( stlUInt16        aInputArgumentCnt,
                                  dtlValueEntry  * aInputArgument,
                                  void           * aResultValue,
                                  void           * aInfo,
                                  dtlFuncVector  * aVectorFunc,
...
//    sDestIntervalIndicatorValue  = aInputArgument[4].mValue.mDataValue;
    ...
    sBigInt = *(dtlBigIntType *)(sSourceValue->mValue);
...
/**
 * @brief BigInt -> Char 으로의 type cast
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
 * @param[out] aResultValue      cast연산결과
 * @param[in,out]  aInfo         function 수행에 필요한 부가 정보
 ...
 * @param[out] aEnv              environment (stlErrorStack) 
 */
stlStatus dtcCastBigIntToChar( stlUInt16        aInputArgumentCnt,
                               dtlValueEntry  * aInputArgument,
                               void           * aResultValue,
                               void           * aInfo,
                               dtlFuncVector  * aVectorFunc,
...
/**
 * @brief BigInt -> Varchar 으로의 type cast
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
 * @param[out] aResultValue      cast연산결과
 * @param[in,out]  aInfo         function 수행에 필요한 부가 정보
 ...
 * @param[out] aEnv              environment (stlErrorStack) 
 */
stlStatus dtcCastBigIntToVarchar( stlUInt16        aInputArgumentCnt,
                                  dtlValueEntry  * aInputArgument,
                                  void           * aResultValue,
                                  void           * aInfo,
                                  dtlFuncVector  * aVectorFunc,
...
/**
 * @brief BigInt -> Longvarchar 으로의 type cast
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
 * @param[out] aResultValue      cast연산결과
 * @param[in,out]  aInfo         function 수행에 필요한 부가 정보
 ...
 * @param[out] aEnv              environment (stlErrorStack) 
 */
stlStatus dtcCastBigIntToLongvarchar( stlUInt16        aInputArgumentCnt,
                                      dtlValueEntry  * aInputArgument,
                                      void           * aResultValue,
                                      void           * aInfo,
                                      dtlFuncVector  * aVectorFunc,
...
/**
 * @brief BigInt -> Interval Year To Month 으로의 type cast
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
 * @param[out] aResultValue      cast연산결과
 * @param[in,out]  aInfo         function 수행에 필요한 부가 정보
 ...
 * @param[out] aEnv              environment (stlErrorStack) 
 */
stlStatus dtcCastBigIntToIntervalYearToMonth( stlUInt16        aInputArgumentCnt,
                                              dtlValueEntry  * aInputArgument,
                                              void           * aResultValue,
                                              void           * aInfo,
                                              dtlFuncVector  * aVectorFunc,
...
/**
 * @brief BigInt -> Interval Day To Second 으로의 type cast
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
 * @param[out] aResultValue      cast연산결과
 * @param[in,out]  aInfo         function 수행에 필요한 부가 정보
 ...
 * @param[out] aEnv              environment (stlErrorStack) 
 */
stlStatus dtcCastBigIntToIntervalDayToSecond( stlUInt16        aInputArgumentCnt,
                                              dtlValueEntry  * aInputArgument,
                                              void           * aResultValue,
                                              void           * aInfo,
                                              dtlFuncVector  * aVectorFunc,
