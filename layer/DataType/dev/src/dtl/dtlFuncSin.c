 ...
 *        $Id: dtlFuncSin.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncSinInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncSinList[] =
{
     { dtlNumericSin,
       { DTL_TYPE_NUMBER },
       DTL_TYPE_NUMBER
...
/*                         void           * aEnv ) */
/* { */
/*     return dtfBigIntSin( aInputArgumentCnt, */
/*                          aInputArgument, */
/*                          aResultValue, */
/*                          aEnv ); */
/* } */
...
stlStatus dtlNumericSin( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfNumericSin( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
...
stlStatus dtlDoubleSin( stlUInt16        aInputArgumentCnt,
                        ...
                        void           * aEnv )
{
    return dtfDoubleSin( aInputArgumentCnt,
                         aInputArgument,
                         aResultValue,
                         aEnv );
}
                             ...
                             stlErrorStack         * aErrorStack )
{
    ...
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncSinInfo,
                                   dtlFuncSinList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    if( dtlDataTypeGroup[ aDataTypeArray[0] ] == DTL_GROUP_BINARY_INTEGER )
    {
        ...
        *aFuncResultDataType = DTL_TYPE_NATIVE_DOUBLE;
        ...
        /* function ptr idx 조정 */
        i = 0;
        while( dtlFuncSinList[i].mFuncPtr != NULL )
        {
            if( dtlFuncSinList[i].mFuncPtr == dtlDoubleSin )
            {
                break;
            }
            else
        ...
        STL_DASSERT( dtlFuncSinList[i].mFuncPtr == dtlDoubleSin );
        *aFuncPtrIdx = i;
    }
    else
    {
                            ...
                            stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlSin가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncSinList[aFuncPtrIdx].mFuncPtr;
