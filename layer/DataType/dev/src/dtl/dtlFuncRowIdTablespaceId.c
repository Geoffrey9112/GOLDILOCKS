...
/**
 * @file dtlFuncRowIdTablespaceId.c
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncRowIdTablespaceIdInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncRowIdTablespaceIdList[] =
{
    { dtlRowIdTablespaceId,
      { DTL_TYPE_ROWID },
...
stlStatus dtlRowIdTablespaceId( stlUInt16        aInputArgumentCnt,
                                ...
                                void           * aEnv )
{
    return dtfRowIdTablespaceId( aInputArgumentCnt,
                                 aInputArgument,
                                 aResultValue,
                                 aEnv );
}
...
/**
 * @brief RowId_Tablespace_Id  function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncRowIdTablespaceIdInfo,
                                   dtlFuncRowIdTablespaceIdList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief RowId_Tablespace_Id function pointer 얻기
                                          ...
                                          stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlRowIdTablespaceId가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncRowIdTablespaceIdList[aFuncPtrIdx].mFuncPtr;
