 ...
 *        $Id: dtlFuncCharLength.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncCharLengthInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncCharLengthList[] =
{
    { dtlCharLength,
      { DTL_TYPE_VARCHAR },
      DTL_TYPE_NATIVE_BIGINT
    },
    { dtlLongvarcharLength,
...
stlStatus dtlCharLength( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfCharLength( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aVectorFunc,
                          aVectorArg,
...
stlStatus dtlLongvarcharLength( stlUInt16        aInputArgumentCnt,
                                ...
                                void           * aEnv )
{
    return dtfLongvarcharLength( aInputArgumentCnt,
                                 aInputArgument,
                                 aResultValue,
                                 aVectorFunc,
                                 aVectorArg,
...
/**
 * @brief CharLength function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncCharLengthInfo,
                                   dtlFuncCharLengthList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief CharLength function pointer 얻기
                                   ...
                                   stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlCharLength가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncCharLengthList[aFuncPtrIdx].mFuncPtr;
