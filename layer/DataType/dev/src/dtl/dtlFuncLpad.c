 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncLpadInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncLpadList[] =
{
     { dtlStringLpad,
       { DTL_TYPE_VARCHAR, DTL_TYPE_NATIVE_INTEGER, DTL_TYPE_VARCHAR },
       DTL_TYPE_VARCHAR
     },
     { dtlLongvarcharStringLpad,
...
stlStatus dtlStringLpad( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfStringLpad( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aVectorFunc,
                          aVectorArg,
                                    ...
                                    void           * aEnv )
{
    ...
    STL_TRY( dtfLongvarcharStringLpad( aInputArgumentCnt,
                                       aInputArgument,
                                       aResultValue,
                                       aVectorFunc,
                                       aVectorArg,
...
stlStatus dtlBinaryLpad( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfBinaryLpad( aInputArgumentCnt,
                          aInputArgument,
                                ...
                                void           * aEnv )
{
    ...
    STL_TRY( dtfBinaryLpad( aInputArgumentCnt,
                            aInputArgument,
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncLpadInfo,
                                   dtlFuncLpadList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief Lpad function pointer 얻기
                             ...
                             stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlLpad가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncLpadList[aFuncPtrIdx].mFuncPtr;
