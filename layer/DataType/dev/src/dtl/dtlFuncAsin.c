 ...
 *        $Id: dtlFuncAsin.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncAsinInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncAsinList[] =
{
     { dtlNumericAsin,
       { DTL_TYPE_NUMBER },
       DTL_TYPE_NUMBER
...
/*                          void           * aEnv ) */
/* { */
/*     return dtfBigIntAsin( aInputArgumentCnt, */
/*                           aInputArgument, */
/*                           aResultValue, */
/*                           aEnv ); */
/* } */
...
stlStatus dtlNumericAsin( stlUInt16        aInputArgumentCnt,
                          ...
                          void           * aEnv )
{
    return dtfNumericAsin( aInputArgumentCnt,
                           aInputArgument,
                           aResultValue,
                           aEnv );
}
...
stlStatus dtlDoubleAsin( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfDoubleAsin( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
                              ...
                              stlErrorStack         * aErrorStack )
{
    ...
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncAsinInfo,
                                   dtlFuncAsinList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    if( dtlDataTypeGroup[ aDataTypeArray[0] ] == DTL_GROUP_BINARY_INTEGER )
    {
        ...
        *aFuncResultDataType = DTL_TYPE_NATIVE_DOUBLE;
        ...
        /* function ptr idx 조정 */
        i = 0;
        while( dtlFuncAsinList[i].mFuncPtr != NULL )
        {
            if( dtlFuncAsinList[i].mFuncPtr == dtlDoubleAsin )
            {
                break;
            }
            else
        ...
        STL_DASSERT( dtlFuncAsinList[i].mFuncPtr == dtlDoubleAsin );
        *aFuncPtrIdx = i;
    }
    else
    {
...
/**
 * @brief Asin function pointer 얻기
                             ...
                             stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlAsin가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncAsinList[aFuncPtrIdx].mFuncPtr;
