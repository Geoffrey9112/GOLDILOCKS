/*******************************************************************************
 * dtlFuncOctetLength.c
 *
 * Copyright (c) 2011, SUNJESOFT Inc.
 *
 *
 * IDENTIFICATION & REVISION
 *        $Id: dtlFuncOctetLength.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncOctetLengthInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncOctetLengthList[] =
{
     { dtlStringOctetLength,
       { DTL_TYPE_VARCHAR },
...
stlStatus dtlStringOctetLength( stlUInt16        aInputArgumentCnt,
                                ...
                                void           * aEnv )
{
    return dtfStringOctetLength( aInputArgumentCnt,
                                 aInputArgument,
                                 aResultValue,
                                 aEnv );
}
...
stlStatus dtlBinaryStringOctetLength( stlUInt16        aInputArgumentCnt,
                                      ...
                                      void           * aEnv )
{
    return dtfBinaryStringOctetLength( aInputArgumentCnt,
                                       aInputArgument,
                                       aResultValue,
                                       aEnv );
}
...
/**
 * @brief OctetLength function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncOctetLengthInfo,
                                   dtlFuncOctetLengthList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief OctetLength function pointer 얻기
                                    ...
                                    stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlOctetLength가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncOctetLengthList[aFuncPtrIdx].mFuncPtr;
