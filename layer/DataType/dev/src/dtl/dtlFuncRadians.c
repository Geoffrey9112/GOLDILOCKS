 ...
 *        $Id: dtlFuncRadians.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncRadiansInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncRadiansList[] =
{
    { dtlNumericRadians,
      { DTL_TYPE_NUMBER },
      DTL_TYPE_NUMBER
...
/*                             void           * aEnv ) */
/* { */
/*     return dtfBigIntRadians( aInputArgumentCnt, */
/*                              aInputArgument, */
/*                              aResultValue, */
/*                              aEnv ); */
/* } */
...
stlStatus dtlNumericRadians( stlUInt16        aInputArgumentCnt,
                             ...
                             void           * aEnv )
{
    return dtfNumericRadians( aInputArgumentCnt,
                              aInputArgument,
                              aResultValue,
                              aEnv );
}
...
stlStatus dtlDoubleRadians( stlUInt16        aInputArgumentCnt,
                            ...
                            void           * aEnv )
{
    return dtfDoubleRadians( aInputArgumentCnt,
                             aInputArgument,
                             aResultValue,
                             aEnv );
}
...
/**
 * @brief Radians function에 대한 정보 얻기
                                 ...
                                 stlErrorStack         * aErrorStack )
{
    ...
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncRadiansInfo,
                                   dtlFuncRadiansList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    if( dtlDataTypeGroup[ aDataTypeArray[0] ] == DTL_GROUP_BINARY_INTEGER )
    {
        ...
        *aFuncResultDataType = DTL_TYPE_NATIVE_DOUBLE;
        ...
        /* function ptr idx 조정 */
        i = 0;
        while( dtlFuncRadiansList[i].mFuncPtr != NULL )
        {
            if( dtlFuncRadiansList[i].mFuncPtr == dtlDoubleRadians )
            {
                break;
            }
            else
        ...
        STL_DASSERT( dtlFuncRadiansList[i].mFuncPtr == dtlDoubleRadians );
        *aFuncPtrIdx = i;
    }
    else
    {
...
/**
 * @brief Radians function pointer 얻기
                            ...
                            stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlRadians가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncRadiansList[aFuncPtrIdx].mFuncPtr;
