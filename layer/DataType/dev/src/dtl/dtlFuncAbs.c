 ...
 *        $Id: dtlFuncAbs.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncAbsInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncAbsList[] =
{
    { dtlAbs,
                             ...
                             stlErrorStack         * aErrorStack )
{
    ...
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncAbsInfo,
                                   dtlFuncAbsList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    STL_DASSERT( gDtfAbsFunc[ *aFuncResultDataType ] != NULL );
...
stlStatus dtlAbs( stlUInt16        aInputArgumentCnt,
                  ...
                  void           * aEnv )
{
    STL_DASSERT( gDtfAbsFunc[ aInputArgument[0].mValue.mDataValue->mType ] != NULL );
    
    STL_TRY( gDtfAbsFunc[ aInputArgument[0].mValue.mDataValue->mType ](
                 aInputArgumentCnt,
                 aInputArgument,
                 aResultValue,
                 aInfo,
