 ...
 *        $Id: dtlFuncRandom.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncRandomInfo =
{
    /*파라미터가 없음으로 STL_FALSE로 설정한다. */
 ...
 */
const dtlFuncArgInfo dtlFuncRandomList[] =
{
    { dtlBigIntRandom,
...
stlStatus dtlBigIntRandom( stlUInt16        aInputArgumentCnt,
                           ...
                           void           * aEnv )
{
    return dtfBigIntRandom( aInputArgumentCnt,
                            aInputArgument,
                            aResultValue,
                            aEnv );
}
...
stlStatus dtlNumericRandom( stlUInt16        aInputArgumentCnt,
                            ...
                            void           * aEnv )
{
    return dtfNumericRandom( aInputArgumentCnt,
                             aInputArgument,
                             aResultValue,
                             aEnv );
}
...
stlStatus dtlDoubleRandom( stlUInt16        aInputArgumentCnt,
                           ...
                           void           * aEnv )
{
    return dtfDoubleRandom( aInputArgumentCnt,
                            aInputArgument,
                            aResultValue,
                            aEnv );
}
...
/**
 * @brief Random function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncRandomInfo,
                                   dtlFuncRandomList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief Random function pointer 얻기
                               ...
                               stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlRandom가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncRandomList[aFuncPtrIdx].mFuncPtr;
