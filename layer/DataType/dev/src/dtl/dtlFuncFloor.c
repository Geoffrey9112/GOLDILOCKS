 ...
 *        $Id: dtlFuncFloor.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncFloorInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncFloorList[] =
{
    { dtlBigIntFloor,
...
stlStatus dtlBigIntFloor( stlUInt16        aInputArgumentCnt,
                          ...
                          void           * aEnv )
{
    return dtfBigIntFloor( aInputArgumentCnt,
                           aInputArgument,
                           aResultValue,
                           aEnv );
}
...
stlStatus dtlNumericFloor( stlUInt16        aInputArgumentCnt,
                           ...
                           void           * aEnv )
{
    return dtfNumericFloor( aInputArgumentCnt,
                            aInputArgument,
                            aResultValue,
                            aEnv );
}
...
stlStatus dtlDoubleFloor( stlUInt16        aInputArgumentCnt,
                          ...
                          void           * aEnv )
{
    return dtfDoubleFloor( aInputArgumentCnt,
                           aInputArgument,
                           aResultValue,
                           aEnv );
}
...
/**
 * @brief Floor function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncFloorInfo,
                                   dtlFuncFloorList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief Floor function pointer 얻기
                              ...
                              stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlFloor가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncFloorList[aFuncPtrIdx].mFuncPtr;
