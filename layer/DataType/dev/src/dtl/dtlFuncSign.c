 ...
 *        $Id: dtlFuncSign.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncSignInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncSignList[] =
{
    { dtlBigIntSign,
...
stlStatus dtlBigIntSign( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfBigIntSign( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
...
stlStatus dtlNumericSign( stlUInt16        aInputArgumentCnt,
                          ...
                          void           * aEnv )
{
    return dtfNumericSign( aInputArgumentCnt,
                           aInputArgument,
                           aResultValue,
                           aEnv );
}
...
stlStatus dtlDoubleSign( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfDoubleSign( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncSignInfo,
                                   dtlFuncSignList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief Sign function pointer 얻기
                             ...
                             stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlSign가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncSignList[aFuncPtrIdx].mFuncPtr;
