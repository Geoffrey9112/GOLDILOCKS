...
/**
 * @file dtlFuncToTimestamp.c
 * @brief Data Type Layer To_Timestamp 함수 
 */
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncToTimestampInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncToTimestampList[] =
{
    { dtlToTimestamp,
...
stlStatus dtlToTimestamp( stlUInt16        aInputArgumentCnt,
                          ...
                          void           * aEnv )
{
    return dtfToTimestamp( aInputArgumentCnt,
                           aInputArgument,
                           aResultValue,
                           aInfo,
                           aVectorFunc,
...
/**
 * @brief To_Timestamp  function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncToTimestampInfo,
                                   dtlFuncToTimestampList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief To_Timestamp function pointer 얻기
                                    ...
                                    stlErrorStack       * aErrorStack )
{
    ...
    *aFuncPtr = dtlFuncToTimestampList[aFuncPtrIdx].mFuncPtr;
