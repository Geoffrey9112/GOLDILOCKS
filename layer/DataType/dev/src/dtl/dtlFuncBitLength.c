 ...
 *        $Id: dtlFuncBitLength.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncBitLengthInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncBitLengthList[] =
{
    { dtlBitLength,
      { DTL_TYPE_VARCHAR },
      DTL_TYPE_NATIVE_BIGINT
    },
    { dtlLongvarcharBitLength,
...
stlStatus dtlBitLength( stlUInt16        aInputArgumentCnt,
                        ...
                        void           * aEnv )
{
    return dtfBitLength( aInputArgumentCnt,
                         aInputArgument,
                         aResultValue,
                         aEnv );
}
...
stlStatus dtlLongvarcharBitLength( stlUInt16        aInputArgumentCnt,
                                   ...
                                   void           * aEnv )
{
    return dtfLongvarcharBitLength( aInputArgumentCnt,
                                    aInputArgument,
                                    aResultValue,
                                    aEnv );
}
...
/**
 * @brief BitLength function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncBitLengthInfo,
                                   dtlFuncBitLengthList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief BitLength function pointer 얻기
                                  ...
                                  stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlBitLength가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncBitLengthList[aFuncPtrIdx].mFuncPtr;
