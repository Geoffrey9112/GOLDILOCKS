 ...
 *        $Id: dtlFuncExp.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncExpInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncExpList[] =
{
     { dtlNumericExp,
       { DTL_TYPE_NUMBER },
       DTL_TYPE_NUMBER
...
/*                         void           * aEnv ) */
/* { */
/*     return dtfBigIntExp( aInputArgumentCnt, */
/*                          aInputArgument, */
/*                          aResultValue, */
/*                          aEnv ); */
/* } */
...
stlStatus dtlNumericExp( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfNumericExp( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
...
stlStatus dtlDoubleExp( stlUInt16        aInputArgumentCnt,
                        ...
                        void           * aEnv )
{
    return dtfDoubleExp( aInputArgumentCnt,
                         aInputArgument,
                         aResultValue,
                         aEnv );
}
                             ...
                             stlErrorStack         * aErrorStack )
{
    ...
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncExpInfo,
                                   dtlFuncExpList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    if( dtlDataTypeGroup[ aDataTypeArray[0] ] == DTL_GROUP_BINARY_INTEGER )
    {
        ...
        *aFuncResultDataType = DTL_TYPE_NATIVE_DOUBLE;
        ...
        /* function ptr idx 조정 */
        i = 0;
        while( dtlFuncExpList[i].mFuncPtr != NULL )
        {
            if( dtlFuncExpList[i].mFuncPtr == dtlDoubleExp )
            {
                break;
            }
            else
        ...
        STL_DASSERT( dtlFuncExpList[i].mFuncPtr == dtlDoubleExp );
        *aFuncPtrIdx = i;
    }
    else
    {
                            ...
                            stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlExp가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncExpList[aFuncPtrIdx].mFuncPtr;
