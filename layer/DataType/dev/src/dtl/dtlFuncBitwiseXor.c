 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncBitwiseXorInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncBitwiseXorList[] =
{
    { dtlBigIntBitwiseXor,
...
stlStatus dtlBigIntBitwiseXor( stlUInt16        aInputArgumentCnt,
                               ...
                               void           * aEnv )
{
    return dtfBigIntBitwiseXor( aInputArgumentCnt,
                                aInputArgument,
                                aResultValue,
                                aEnv );
}
...
stlStatus dtlNumberBitwiseXor( stlUInt16        aInputArgumentCnt,
                               ...
                               void           * aEnv )
{
    return dtfNumberBitwiseXor( aInputArgumentCnt,
                                aInputArgument,
                                aResultValue,
                                aEnv );
}
...
/**
 * @brief bitwise Xor function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncBitwiseXorInfo,
                                   dtlFuncBitwiseXorList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief bitwise Xor function pointer 얻기
                                   ...
                                   stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlBitwiseXor가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncBitwiseXorList[aFuncPtrIdx].mFuncPtr;
