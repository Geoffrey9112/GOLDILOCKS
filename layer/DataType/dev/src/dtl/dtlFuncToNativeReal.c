...
/**
 * @file dtlFuncToNativeReal.c
 * @brief Data Type Layer To_Native_Real 함수 
 */
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncToNativeRealInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncToNativeRealList[] =
{
    { dtlToNativeReal,
...
stlStatus dtlToNativeReal( stlUInt16        aInputArgumentCnt,
                           ...
                           void           * aEnv )
{
    return dtfToNativeReal( aInputArgumentCnt,
                            aInputArgument,
                            aResultValue,
                            aInfo,
                            aVectorFunc,
...
/**
 * @brief To_Native_Real  function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncToNativeRealInfo,
                                   dtlFuncToNativeRealList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief To_Native_Real function pointer 얻기
                                     ...
                                     stlErrorStack       * aErrorStack )
{
    ...
    *aFuncPtr = dtlFuncToNativeRealList[aFuncPtrIdx].mFuncPtr;
