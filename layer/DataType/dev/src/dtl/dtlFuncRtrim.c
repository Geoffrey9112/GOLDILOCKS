 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncRtrimInfo =
{
...
stlStatus dtlStringRtrim( stlUInt16        aInputArgumentCnt,
                          ...
                          void           * aEnv )
{
    return dtfStringRtrim( aInputArgumentCnt,
                           aInputArgument,
                           aResultValue,
                           aVectorFunc,
                           aVectorArg,
                                     ...
                                     void           * aEnv )
{
    ...
    STL_TRY( dtfStringRtrim( aInputArgumentCnt,
                             aInputArgument,
                             aResultValue,
                             aVectorFunc,
                             aVectorArg,
...
stlStatus dtlBinaryStringRtrim( stlUInt16        aInputArgumentCnt,
                                ...
                                void           * aEnv )
{
    return dtfBinaryStringRtrim( aInputArgumentCnt,
                                 aInputArgument,
                                 aResultValue,
                                 aVectorFunc,
                                 aVectorArg,
                                       ...
                                       void           * aEnv )
{
    ...
    STL_TRY( dtfBinaryStringRtrim( aInputArgumentCnt,
                                   aInputArgument,
                                   aResultValue,
                                   aVectorFunc,
                                   aVectorArg,
...
/**
 * @brief RTrim function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncRtrimInfo,
                                   dtlFuncRtrimList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    /*
     * RRIM( trim_source, trim_character ) 
     *      ^^^^^^^^^^^^^
     *
...
/**
 * @brief Rtrim function pointer 얻기
                              ...
                              stlErrorStack       * aErrorStack )
{
     ...
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncRtrimList[aFuncPtrIdx].mFuncPtr;
