 ...
 *        $Id: dtlFuncAtan.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncAtanInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncAtanList[] =
{
    { dtlNumericAtan,
      { DTL_TYPE_NUMBER },
      DTL_TYPE_NUMBER
...
/*                          void           * aEnv ) */
/* { */
/*     return dtfBigIntAtan( aInputArgumentCnt, */
/*                           aInputArgument, */
/*                           aResultValue, */
/*                           aEnv ); */
/* } */
...
stlStatus dtlNumericAtan( stlUInt16        aInputArgumentCnt,
                          ...
                          void           * aEnv )
{
    return dtfNumericAtan( aInputArgumentCnt,
                           aInputArgument,
                           aResultValue,
                           aEnv );
}
...
stlStatus dtlDoubleAtan( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfDoubleAtan( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
                              ...
                              stlErrorStack         * aErrorStack )
{
    ...
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncAtanInfo,
                                   dtlFuncAtanList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    if( dtlDataTypeGroup[ aDataTypeArray[0] ] == DTL_GROUP_BINARY_INTEGER )
    {
        ...
        *aFuncResultDataType = DTL_TYPE_NATIVE_DOUBLE;
        ...
        /* function ptr idx 조정 */
        i = 0;
        while( dtlFuncAtanList[i].mFuncPtr != NULL )
        {
            if( dtlFuncAtanList[i].mFuncPtr == dtlDoubleAtan )
            {
                break;
            }
            else
        ...
        STL_DASSERT( dtlFuncAtanList[i].mFuncPtr == dtlDoubleAtan );
        *aFuncPtrIdx = i;
    }
    else
    {
...
/**
 * @brief Atan function pointer 얻기
                             ...
                             stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlAtan가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncAtanList[aFuncPtrIdx].mFuncPtr;
