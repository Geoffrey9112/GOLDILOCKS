 ...
 *        $Id: dtlFuncPosition.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncPositionInfo =
{
...
stlStatus dtlStringPosition( stlUInt16        aInputArgumentCnt,
                             ...
                             void           * aEnv )
{
    return dtfStringPosition( aInputArgumentCnt,
                              aInputArgument,
                              aResultValue,
                              aVectorFunc,
                              aVectorArg,
...
stlStatus dtlBinaryStringPosition( stlUInt16        aInputArgumentCnt,
                                   ...
                                   void           * aEnv )
{
    return dtfBinaryStringPosition( aInputArgumentCnt,
                                    aInputArgument,
                                    aResultValue,
                                    aVectorFunc,
                                    aVectorArg,
...
/**
 * @brief Position function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncPositionInfo,
                                   dtlFuncPositionList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief Position function pointer 얻기
                                 ...
                                 stlErrorStack       * aErrorStack )
{
     ...
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncPositionList[aFuncPtrIdx].mFuncPtr;
