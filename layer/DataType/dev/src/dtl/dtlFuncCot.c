 ...
 *        $Id: dtlFuncCot.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncCotInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncCotList[] =
{
    { dtlNumericCot,
      { DTL_TYPE_NUMBER },
      DTL_TYPE_NUMBER
...
/*                         void           * aEnv ) */
/* { */
/*     return dtfBigIntCot( aInputArgumentCnt, */
/*                          aInputArgument, */
/*                          aResultValue, */
/*                          aEnv ); */
/* } */
...
stlStatus dtlNumericCot( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfNumericCot( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
...
stlStatus dtlDoubleCot( stlUInt16        aInputArgumentCnt,
                        ...
                        void           * aEnv )
{
    return dtfDoubleCot( aInputArgumentCnt,
                         aInputArgument,
                         aResultValue,
                         aEnv );
}
                             ...
                             stlErrorStack         * aErrorStack )
{
    ...
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncCotInfo,
                                   dtlFuncCotList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    if( dtlDataTypeGroup[ aDataTypeArray[0] ] == DTL_GROUP_BINARY_INTEGER )
    {
        ...
        *aFuncResultDataType = DTL_TYPE_NATIVE_DOUBLE;
        ...
        /* function ptr idx 조정 */
        i = 0;
        while( dtlFuncCotList[i].mFuncPtr != NULL )
        {
            if( dtlFuncCotList[i].mFuncPtr == dtlDoubleCot )
            {
                break;
            }
            else
        ...
        STL_DASSERT( dtlFuncCotList[i].mFuncPtr == dtlDoubleCot );
        *aFuncPtrIdx = i;
    }
    else
    {
                            ...
                            stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlCot가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncCotList[aFuncPtrIdx].mFuncPtr;
