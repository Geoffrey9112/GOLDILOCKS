 ...
 *        $Id: dtlFuncLn.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncLnInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncLnList[] =
{
    { dtlBigIntLn,
...
stlStatus dtlBigIntLn( stlUInt16        aInputArgumentCnt,
                       ...
                       void           * aEnv )
{
    return dtfBigIntLn( aInputArgumentCnt,
                        aInputArgument,
                        aResultValue,
                        aEnv );
}
...
stlStatus dtlNumericLn( stlUInt16        aInputArgumentCnt,
                        ...
                        void           * aEnv )
{
    return dtfNumericLn( aInputArgumentCnt,
                         aInputArgument,
                         aResultValue,
                         aEnv );
}
...
stlStatus dtlDoubleLn( stlUInt16        aInputArgumentCnt,
                       ...
                       void           * aEnv )
{
    return dtfDoubleLn( aInputArgumentCnt,
                        aInputArgument,
                        aResultValue,
                        aEnv );
}
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncLnInfo,
                                   dtlFuncLnList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
                           ...
                           stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlLn가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncLnList[aFuncPtrIdx].mFuncPtr;
