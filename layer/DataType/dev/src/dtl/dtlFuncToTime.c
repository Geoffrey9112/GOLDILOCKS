...
/**
 * @file dtlFuncToTime.c
 * @brief Data Type Layer To_Time 함수 
 */
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncToTimeInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncToTimeList[] =
{
    { dtlToTime,
...
stlStatus dtlToTime( stlUInt16        aInputArgumentCnt,
                     ...
                     void           * aEnv )
{
    return dtfToTime( aInputArgumentCnt,
                      aInputArgument,
                      aResultValue,
                      aInfo,
                      aVectorFunc,
...
/**
 * @brief To_Time  function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncToTimeInfo,
                                   dtlFuncToTimeList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief To_Time function pointer 얻기
                               ...
                               stlErrorStack       * aErrorStack )
{
    ...
    *aFuncPtr = dtlFuncToTimeList[aFuncPtrIdx].mFuncPtr;
