 ...
 *        $Id: dtlFuncFactorial.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncFactorialInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncFactorialList[] =
{
     { dtlBigIntFact,
...
stlStatus dtlBigIntFact( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfBigIntFact( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
...
stlStatus dtlNumericFact( stlUInt16        aInputArgumentCnt,
                          ...
                          void           * aEnv )
{
    return dtfNumericFact( aInputArgumentCnt,
                           aInputArgument,
                           aResultValue,
                           aEnv );
}
...
/**
 * @brief Factorial function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncFactorialInfo,
                                   dtlFuncFactorialList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief Factorial function pointer 얻기
                                  ...
                                  stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlFactorial가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncFactorialList[aFuncPtrIdx].mFuncPtr;
