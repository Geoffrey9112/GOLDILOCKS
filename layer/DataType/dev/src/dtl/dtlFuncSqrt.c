 ...
 *        $Id: dtlFuncSqrt.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncSqrtInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncSqrtList[] =
{
    { dtlNumericSqrt,
      { DTL_TYPE_NUMBER },
      DTL_TYPE_NUMBER
...
/*                          void           * aEnv ) */
/* { */
/*     return dtfBigIntSqrt( aInputArgumentCnt, */
/*                           aInputArgument, */
/*                           aResultValue, */
/*                           aEnv ); */
/* } */
...
stlStatus dtlNumericSqrt( stlUInt16        aInputArgumentCnt,
                          ...
                          void           * aEnv )
{
    return dtfNumericSqrt( aInputArgumentCnt,
                           aInputArgument,
                           aResultValue,
                           aEnv );
}
...
stlStatus dtlDoubleSqrt( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfDoubleSqrt( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
                              ...
                              stlErrorStack         * aErrorStack )
{
    ...
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncSqrtInfo,
                                   dtlFuncSqrtList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    if( dtlDataTypeGroup[ aDataTypeArray[0] ] == DTL_GROUP_BINARY_INTEGER )
    {
        ...
        *aFuncResultDataType = DTL_TYPE_NATIVE_DOUBLE;
        ...
        /* function ptr idx 조정 */
        i = 0;
        while( dtlFuncSqrtList[i].mFuncPtr != NULL )
        {
            if( dtlFuncSqrtList[i].mFuncPtr == dtlDoubleSqrt )
            {
                break;
            }
            else
        ...
        STL_DASSERT( dtlFuncSqrtList[i].mFuncPtr == dtlDoubleSqrt );
        *aFuncPtrIdx = i;
    }
    else
    {
...
/**
 * @brief Sqrt function pointer 얻기
                             ...
                             stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlSqrt가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncSqrtList[aFuncPtrIdx].mFuncPtr;
