 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncAddTimeInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncAddTimeList[] =
{
    { dtlTimeAddTimeIntervalDayToSecond,
      { DTL_TYPE_TIME, DTL_TYPE_INTERVAL_DAY_TO_SECOND },
      DTL_TYPE_TIME
    },
    { dtlTimeTzAddTimeIntervalDayToSecond,
      { DTL_TYPE_TIME_WITH_TIME_ZONE, DTL_TYPE_INTERVAL_DAY_TO_SECOND },
      DTL_TYPE_TIME_WITH_TIME_ZONE
    },
    { dtlTimestampAddTimeIntervalDayToSecond,
      { DTL_TYPE_TIMESTAMP, DTL_TYPE_INTERVAL_DAY_TO_SECOND },
      DTL_TYPE_TIMESTAMP
    },
    { dtlTimestampTzAddTimeIntervalDayToSecond,
...
stlStatus dtlTimeAddTimeIntervalDayToSecond( stlUInt16        aInputArgumentCnt,
...
stlStatus dtlTimeTzAddTimeIntervalDayToSecond( stlUInt16        aInputArgumentCnt,
                                               dtlValueEntry  * aInputArgument,
                                               void           * aResultValue,
                                               void           * aInfo,
                                               dtlFuncVector  * aVectorFunc,
...
stlStatus dtlTimestampAddTimeIntervalDayToSecond( stlUInt16        aInputArgumentCnt,
                                                  dtlValueEntry  * aInputArgument,
                                                  void           * aResultValue,
                                                  void           * aInfo,
                                                  dtlFuncVector  * aVectorFunc,
...
stlStatus dtlTimestampTzAddTimeIntervalDayToSecond( stlUInt16        aInputArgumentCnt,
                                                    dtlValueEntry  * aInputArgument,
                                                    void           * aResultValue,
                                                    void           * aInfo,
                                                    dtlFuncVector  * aVectorFunc,
...
/**
 * @brief addtime function에 대한 정보 얻기
 ...
 */
stlStatus dtlGetFuncInfoAddTime( stlUInt16               aDataTypeArrayCount,
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncAddTimeInfo,
                                   dtlFuncAddTimeList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief adddtime function pointer 얻기
 * @param[in]  aFuncPtrIdx       function pointer 얻기 위한 식별자
 * @param[out] aFuncPtr          function pointer
 * @param[out] aErrorStack       에러 스택
 */
stlStatus dtlGetFuncPtrAddTime( stlUInt32             aFuncPtrIdx,
                                ...
                                stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlAddTime가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncAddTimeList[aFuncPtrIdx].mFuncPtr;
