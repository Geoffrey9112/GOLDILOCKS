 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncBitwiseAndInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncBitwiseAndList[] =
{
     { dtlBigIntBitwiseAnd,
...
stlStatus dtlBigIntBitwiseAnd( stlUInt16        aInputArgumentCnt,
                               ...
                               void           * aEnv )
{
    return dtfBigIntBitwiseAnd( aInputArgumentCnt,
                                aInputArgument,
                                aResultValue,
                                aEnv );
}
...
stlStatus dtlNumberBitwiseAnd( stlUInt16        aInputArgumentCnt,
                               ...
                               void           * aEnv )
{
    return dtfNumberBitwiseAnd( aInputArgumentCnt,
                                aInputArgument,
                                aResultValue,
                                aEnv );
}
...
/**
 * @brief bitwise And function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncBitwiseAndInfo,
                                   dtlFuncBitwiseAndList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    if( aFuncArgDataTypeArray[0] == DTL_TYPE_NATIVE_DOUBLE )
    {
        ...
        aFuncArgDataTypeArray[1] = DTL_TYPE_NUMBER;
        DTL_COPY_DATA_TYPE_DEF_INFO( & aFuncArgDataTypeDefInfoArray[1],
                                     & gResultDataTypeDef[ aFuncArgDataTypeArray[1] ] );        
    }
...
/**
 * @brief bitwise And function pointer 얻기
                                   ...
                                   stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlBitwiseAnd가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncBitwiseAndList[aFuncPtrIdx].mFuncPtr;
