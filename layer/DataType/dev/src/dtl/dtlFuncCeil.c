 ...
 *        $Id: dtlFuncCeil.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncCeilInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncCeilList[] =
{
     { dtlBigIntCeil,
...
stlStatus dtlBigIntCeil( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfBigIntCeil( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
...
stlStatus dtlNumericCeil( stlUInt16        aInputArgumentCnt,
                          ...
                          void           * aEnv )
{
    return dtfNumericCeil( aInputArgumentCnt,
                           aInputArgument,
                           aResultValue,
                           aEnv );
}
...
stlStatus dtlDoubleCeil( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfDoubleCeil( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncCeilInfo,
                                   dtlFuncCeilList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief Ceil function pointer 얻기
                             ...
                             stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlCeil가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncCeilList[aFuncPtrIdx].mFuncPtr;
