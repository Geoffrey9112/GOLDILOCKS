 ...
 *        $Id: dtlFuncPositive.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncPositiveInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncPositiveList[] =
{
     { dtlPositive,
...
/**
 * @brief Positive function에 대한 정보 얻기
 ...
 */
stlStatus dtlGetFuncInfoPositive( stlUInt16               aDataTypeArrayCount,
                                  ...
                                  stlErrorStack         * aErrorStack )
{
    ...
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncPositiveInfo,
                                   dtlFuncPositiveList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    STL_DASSERT( gDtfPositiveFunc[ *aFuncResultDataType ] != NULL );
...
/**
 * @brief Positive function pointer 얻기
 * @param[in]  aFuncPtrIdx       function pointer 얻기 위한 식별자
 * @param[out] aFuncPtr          function pointer
 * @param[out] aErrorStack       에러 스택
 */
stlStatus dtlGetFuncPtrPositive( stlUInt32             aFuncPtrIdx,
                                 ...
                                 stlErrorStack       * aErrorStack )
{
    ...
    *aFuncPtr = dtlPositive;

    return STL_SUCCESS;
}


stlStatus dtlPositive( stlUInt16        aInputArgumentCnt,
                       ...
                       void           * aEnv )
{
    STL_DASSERT( gDtfPositiveFunc[ aInputArgument[0].mValue.mDataValue->mType ] != NULL );
    
    STL_TRY( gDtfPositiveFunc[ aInputArgument[0].mValue.mDataValue->mType ](
                 aInputArgumentCnt,
                 aInputArgument,
                 aResultValue,
                 aInfo,
