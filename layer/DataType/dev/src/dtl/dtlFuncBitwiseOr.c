 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncBitwiseOrInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncBitwiseOrList[] =
{
    { dtlBigIntBitwiseOr,
...
stlStatus dtlBigIntBitwiseOr( stlUInt16        aInputArgumentCnt,
                              ...
                              void           * aEnv )
{
    return dtfBigIntBitwiseOr( aInputArgumentCnt,
                               aInputArgument,
                               aResultValue,
                               aEnv );
}
...
stlStatus dtlNumberBitwiseOr( stlUInt16        aInputArgumentCnt,
                              ...
                              void           * aEnv )
{
    return dtfNumberBitwiseOr( aInputArgumentCnt,
                               aInputArgument,
                               aResultValue,
                               aEnv );
}
...
/**
 * @brief bitwise Or function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncBitwiseOrInfo,
                                   dtlFuncBitwiseOrList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief bitwise Or function pointer 얻기
                                  ...
                                  stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlBitwiseOr가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncBitwiseOrList[aFuncPtrIdx].mFuncPtr;
