 ...
 *        $Id: dtlFuncCos.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncCosInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncCosList[] =
{
     { dtlNumericCos,
       { DTL_TYPE_NUMBER },
       DTL_TYPE_NUMBER
...
/*                         void           * aEnv ) */
/* { */
/*     return dtfBigIntCos( aInputArgumentCnt, */
/*                          aInputArgument, */
/*                          aResultValue, */
/*                          aEnv ); */
/* } */
...
stlStatus dtlNumericCos( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfNumericCos( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
...
stlStatus dtlDoubleCos( stlUInt16        aInputArgumentCnt,
                        ...
                        void           * aEnv )
{
    return dtfDoubleCos( aInputArgumentCnt,
                         aInputArgument,
                         aResultValue,
                         aEnv );
}
                             ...
                             stlErrorStack         * aErrorStack )
{
    ...
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncCosInfo,
                                   dtlFuncCosList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    if( dtlDataTypeGroup[ aDataTypeArray[0] ] == DTL_GROUP_BINARY_INTEGER )
    {
        ...
        *aFuncResultDataType = DTL_TYPE_NATIVE_DOUBLE;
        ...
        /* function ptr idx 조정 */
        i = 0;
        while( dtlFuncCosList[i].mFuncPtr != NULL )
        {
            if( dtlFuncCosList[i].mFuncPtr == dtlDoubleCos )
            {
                break;
            }
            else
        ...
        STL_DASSERT( dtlFuncCosList[i].mFuncPtr == dtlDoubleCos );
        *aFuncPtrIdx = i;
    }
    else
    {
                            ...
                            stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlCos가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncCosList[aFuncPtrIdx].mFuncPtr;
