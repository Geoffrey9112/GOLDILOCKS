 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncInstrInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncInstrList[] =
{
    { dtlStringInstr,
      { DTL_TYPE_VARCHAR, DTL_TYPE_VARCHAR, DTL_TYPE_NATIVE_BIGINT, DTL_TYPE_NATIVE_BIGINT },
      DTL_TYPE_NUMBER
    },
    { dtlLongvarcharStringInstr,
      { DTL_TYPE_LONGVARCHAR, DTL_TYPE_LONGVARCHAR, DTL_TYPE_NATIVE_BIGINT, DTL_TYPE_NATIVE_BIGINT },
      DTL_TYPE_NUMBER
    },

    { dtlBinaryStringInstr,
      { DTL_TYPE_VARBINARY, DTL_TYPE_VARBINARY, DTL_TYPE_NATIVE_BIGINT, DTL_TYPE_NATIVE_BIGINT },
      DTL_TYPE_NUMBER
    },
    { dtlLongvarbinaryStringInstr,
      { DTL_TYPE_LONGVARBINARY, DTL_TYPE_LONGVARBINARY, DTL_TYPE_NATIVE_BIGINT, DTL_TYPE_NATIVE_BIGINT },
      DTL_TYPE_NUMBER
    },
...
stlStatus dtlStringInstr( stlUInt16        aInputArgumentCnt,
                          ...
                          void           * aEnv )
{
    return dtfStringInstr( aInputArgumentCnt,
                           aInputArgument,
                           aResultValue,
                           aVectorFunc,
                           aVectorArg,
...
stlStatus dtlBinaryStringInstr( stlUInt16        aInputArgumentCnt,
                                ...
                                void           * aEnv )
{
    return dtfBinaryStringInstr( aInputArgumentCnt,
                                 aInputArgument,
                                 aResultValue,
                                 aVectorFunc,
                                 aVectorArg,
...
/**
 * @brief Instr function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncInstrInfo,
                                   dtlFuncInstrList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief Instr function pointer 얻기
                              ...
                              stlErrorStack       * aErrorStack )
{
     ...
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncInstrList[aFuncPtrIdx].mFuncPtr;
