 ...
 *        $Id: dtlFuncLower.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncLowerInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncLowerList[] =
{
    { dtlLower,
      { DTL_TYPE_VARCHAR },
      DTL_TYPE_VARCHAR
...
stlStatus dtlLower( stlUInt16        aInputArgumentCnt,
                    ...
                    void           * aEnv )
{
    return dtfLower( aInputArgumentCnt,
                     aInputArgument,
                     aResultValue,
                     aVectorFunc,
                     aVectorArg,
                               ...
                               void           * aEnv )
{
    ...
    STL_TRY( dtfLower( aInputArgumentCnt,
                       aInputArgument,
                       aResultValue,
                       aVectorFunc,
                       aVectorArg,
...
/**
 * @brief Lower function에 대한 정보 얻기
                               ...
                               stlErrorStack         * aErrorStack )
{
    ...
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncLowerInfo,
                                   dtlFuncLowerList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief Lower function pointer 얻기
                              ...
                              stlErrorStack       * aErrorStack )
{
    ...
    *aFuncPtr = dtlFuncLowerList[aFuncPtrIdx].mFuncPtr;
