 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncRowIdObjectInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncRowIdObjectIdList[] =
{
    { dtlRowIdObjectId,
      { DTL_TYPE_ROWID },
...
stlStatus dtlRowIdObjectId( stlUInt16        aInputArgumentCnt,
                            ...
                            void           * aEnv )
{
    return dtfRowIdObjectId( aInputArgumentCnt,
                             aInputArgument,
                             aResultValue,
                             aEnv );
}
...
/**
 * @brief RowId_Object_Id  function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncRowIdObjectInfo,
                                   dtlFuncRowIdObjectIdList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief RowId_Object_Id function pointer 얻기
                                      ...
                                      stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlRowIdObjectId가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncRowIdObjectIdList[aFuncPtrIdx].mFuncPtr;
