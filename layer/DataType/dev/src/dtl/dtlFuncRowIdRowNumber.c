 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncRowIdRowNumberInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncRowIdRowNumberList[] =
{
    { dtlRowIdRowNumber,
      { DTL_TYPE_ROWID },
...
stlStatus dtlRowIdRowNumber( stlUInt16        aInputArgumentCnt,
                             ...
                             void           * aEnv )
{
    return dtfRowIdRowNumber( aInputArgumentCnt,
                              aInputArgument,
                              aResultValue,
                              aEnv );
}
...
/**
 * @brief RowId_Row_Number  function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncRowIdRowNumberInfo,
                                   dtlFuncRowIdRowNumberList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief RowId_Row_Number function pointer 얻기
                                       ...
                                       stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlRowIdRowNumber가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncRowIdRowNumberList[aFuncPtrIdx].mFuncPtr;
