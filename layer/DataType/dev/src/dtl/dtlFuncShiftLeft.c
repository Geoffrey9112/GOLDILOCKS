 ...
 *        $Id: dtlFuncShiftLeft.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncShiftLeftInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncShiftLeftList[] =
{
    { dtlBitwiseShiftLeft,
...
/**
 * @brief ShiftLeft function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncShiftLeftInfo,
                                   dtlFuncShiftLeftList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    STL_DASSERT( gDtfBitwiseShiftLeftFunc[ aFuncArgDataTypeArray[0] ] != NULL );
...
/**
 * @brief ShiftLeft function pointer 얻기
...
stlStatus dtlBitwiseShiftLeft( stlUInt16        aInputArgumentCnt,
                               ...
                               void           * aEnv )
{
    STL_DASSERT( gDtfBitwiseShiftLeftFunc[ aInputArgument[0].mValue.mDataValue->mType ] != NULL );
    
    STL_TRY( gDtfBitwiseShiftLeftFunc[ aInputArgument[0].mValue.mDataValue->mType ](
                 aInputArgumentCnt,
                 aInputArgument,
                 aResultValue,
                 aInfo,
