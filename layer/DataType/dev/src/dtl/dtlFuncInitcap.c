 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncInitcapInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncInitcapList[] =
{
    { dtlInitcap,
      { DTL_TYPE_VARCHAR },
      DTL_TYPE_VARCHAR
    },
    { dtlLongvarcharInitcap,
...
stlStatus dtlInitcap( stlUInt16        aInputArgumentCnt,
                      ...
                      void           * aEnv )
{
    return dtfInitcap( aInputArgumentCnt,
                       aInputArgument,
                       aResultValue,
                       aVectorFunc,
                       aVectorArg,
                                 ...
                                 void           * aEnv )
{
    ...
    STL_TRY( dtfInitcap( aInputArgumentCnt,
                         aInputArgument,
                         aResultValue,
                         aVectorFunc,
                         aVectorArg,
...
/**
 * @brief Initcap function에 대한 정보 얻기
                                 ...
                                 stlErrorStack         * aErrorStack )
{
    ...
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncInitcapInfo,
                                   dtlFuncInitcapList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief Initcap function pointer 얻기
                                ...
                                stlErrorStack       * aErrorStack )
{
    ...
    *aFuncPtr = dtlFuncInitcapList[aFuncPtrIdx].mFuncPtr;    
