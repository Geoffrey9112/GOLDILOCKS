 ...
 *        $Id: dtlFuncCbrt.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncCbrtInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncCbrtList[] =
{
     { dtlBigIntCbrt,
...
stlStatus dtlBigIntCbrt( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfBigIntCbrt( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
...
stlStatus dtlNumericCbrt( stlUInt16        aInputArgumentCnt,
                          ...
                          void           * aEnv )
{
    return dtfNumericCbrt( aInputArgumentCnt,
                           aInputArgument,
                           aResultValue,
                           aEnv );
}
...
stlStatus dtlDoubleCbrt( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfDoubleCbrt( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncCbrtInfo,
                                   dtlFuncCbrtList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief Cbrt function pointer 얻기
                             ...
                             stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlCbrt가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncCbrtList[aFuncPtrIdx].mFuncPtr;
