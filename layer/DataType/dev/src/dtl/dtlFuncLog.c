 ...
 *        $Id: dtlFuncLog.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncLogInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncLogList[] =
{
    { dtlNumericLog,
...
stlStatus dtlDoubleLog( stlUInt16        aInputArgumentCnt,
                        ...
                        void           * aEnv )
{
    return dtfDoubleLog( aInputArgumentCnt,
                         aInputArgument,
                         aResultValue,
                         aEnv );
}
...
stlStatus dtlNumericLog( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfNumericLog( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
                             ...
                             stlErrorStack         * aErrorStack )
{
    ...
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncLogInfo,
                                   dtlFuncLogList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    if( dtlDataTypeGroup[ aDataTypeArray[0] ] == DTL_GROUP_BINARY_INTEGER )
    {
        ...
        *aFuncResultDataType = DTL_TYPE_NATIVE_DOUBLE;
        ...
        /* function ptr idx 조정 */
        i = 0;
        while( dtlFuncLogList[i].mFuncPtr != NULL )
        {
            if( dtlFuncLogList[i].mFuncPtr == dtlDoubleLog )
            {
                break;
            }
            else
        ...
        STL_DASSERT( dtlFuncLogList[i].mFuncPtr == dtlDoubleLog );
        *aFuncPtrIdx = i;
    }
    else
    {
                            ...
                            stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlLog가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncLogList[aFuncPtrIdx].mFuncPtr;
