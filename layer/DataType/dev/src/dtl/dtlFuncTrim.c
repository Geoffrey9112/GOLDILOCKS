 ...
 *        $Id: dtlFuncTrim.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
...
/**
 * @brief TRIM SPECIFICATION string
 */
const stlChar dtlTrimSpecificationStr[ DTL_TRIM_SPEC_MAX ][ DTL_FUNC_TRIM_SPECIFICATION_STR_MAX_SIZE ] =
{
    "LEADING",
    "TRAILING",
    "BOTH",
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncTrimInfo =
{
    { STL_FALSE, STL_TRUE, STL_TRUE, }      /* 함수를 결정하는데 판단이 되는 argument cnt */
};
 ...
 */
const dtlFuncArgInfo dtlFuncTrimList[] =
{
     { dtlStringTrim,
       { DTL_TYPE_NATIVE_BIGINT, DTL_TYPE_VARCHAR, DTL_TYPE_VARCHAR },
       DTL_TYPE_VARCHAR
     },
     { dtlLongvarcharStringTrim,
       { DTL_TYPE_NATIVE_BIGINT, DTL_TYPE_LONGVARCHAR, DTL_TYPE_LONGVARCHAR },
       DTL_TYPE_LONGVARCHAR
     },
     { dtlBinaryStringTrim,
       { DTL_TYPE_NATIVE_BIGINT, DTL_TYPE_VARBINARY, DTL_TYPE_VARBINARY },
       DTL_TYPE_VARBINARY
     },
     { dtlLongvarbinaryStringTrim,
       { DTL_TYPE_NATIVE_BIGINT, DTL_TYPE_LONGVARBINARY, DTL_TYPE_LONGVARBINARY },
...
stlStatus dtlStringTrim( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfStringTrim( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aVectorFunc,
                          aVectorArg,
                                    ...
                                    void           * aEnv )
{
    ...
    STL_TRY( dtfStringTrim( aInputArgumentCnt,
                            aInputArgument,
                            aResultValue,
                            aVectorFunc,
                            aVectorArg,
...
stlStatus dtlBinaryStringTrim( stlUInt16        aInputArgumentCnt,
                               ...
                               void           * aEnv )
{
    return dtfBinaryStringTrim( aInputArgumentCnt,
                                aInputArgument,
                                aResultValue,
                                aEnv );
}
                                      ...
                                      void           * aEnv )
{
    ...
    STL_TRY( dtfBinaryStringTrim( aInputArgumentCnt,
                                  aInputArgument,
                                  aResultValue,
                                  aEnv )
             == STL_SUCCESS );
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncTrimInfo,
                                   dtlFuncTrimList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief Trim function pointer 얻기
                             ...
                             stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlTrim가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncTrimList[aFuncPtrIdx].mFuncPtr;
