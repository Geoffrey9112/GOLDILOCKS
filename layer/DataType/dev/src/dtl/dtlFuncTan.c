 ...
 *        $Id: dtlFuncTan.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncTanInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncTanList[] =
{
     { dtlNumericTan,
       { DTL_TYPE_NUMBER },
       DTL_TYPE_NUMBER
...
/*                         void           * aEnv ) */
/* { */
/*     return dtfBigIntTan( aInputArgumentCnt, */
/*                          aInputArgument, */
/*                          aResultValue, */
/*                          aEnv ); */
/* } */
...
stlStatus dtlNumericTan( stlUInt16        aInputArgumentCnt,
                         ...
                         void           * aEnv )
{
    return dtfNumericTan( aInputArgumentCnt,
                          aInputArgument,
                          aResultValue,
                          aEnv );
}
...
stlStatus dtlDoubleTan( stlUInt16        aInputArgumentCnt,
                        ...
                        void           * aEnv )
{
    return dtfDoubleTan( aInputArgumentCnt,
                         aInputArgument,
                         aResultValue,
                         aEnv );
}
                             ...
                             stlErrorStack         * aErrorStack )
{
    ...
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncTanInfo,
                                   dtlFuncTanList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    if( dtlDataTypeGroup[ aDataTypeArray[0] ] == DTL_GROUP_BINARY_INTEGER )
    {
        ...
        *aFuncResultDataType = DTL_TYPE_NATIVE_DOUBLE;
        ...
        /* function ptr idx 조정 */
        i = 0;
        while( dtlFuncTanList[i].mFuncPtr != NULL )
        {
            if( dtlFuncTanList[i].mFuncPtr == dtlDoubleTan )
            {
                break;
            }
            else
        ...
        STL_DASSERT( dtlFuncTanList[i].mFuncPtr == dtlDoubleTan );
        *aFuncPtrIdx = i;
    }
    else
    {
                            ...
                            stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlTan가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncTanList[aFuncPtrIdx].mFuncPtr;
