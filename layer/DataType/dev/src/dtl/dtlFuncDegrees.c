 ...
 *        $Id: dtlFuncDegrees.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncDegreesInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncDegreesList[] =
{
     { dtlNumericDegrees,
...
/*                             void           * aEnv ) */
/* { */
/*     return dtfBigIntDegrees( aInputArgumentCnt, */
/*                              aInputArgument, */
/*                              aResultValue, */
/*                              aEnv ); */
/* } */
...
stlStatus dtlNumericDegrees( stlUInt16        aInputArgumentCnt,
                             ...
                             void           * aEnv )
{
    return dtfNumericDegrees( aInputArgumentCnt,
                              aInputArgument,
                              aResultValue,
                              aEnv );
}
...
stlStatus dtlDoubleDegrees( stlUInt16        aInputArgumentCnt,
                            ...
                            void           * aEnv )
{
    return dtfDoubleDegrees( aInputArgumentCnt,
                             aInputArgument,
                             aResultValue,
                             aEnv );
}
...
/**
 * @brief Degrees function에 대한 정보 얻기
                                 ...
                                 stlErrorStack         * aErrorStack )
{
    ...
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncDegreesInfo,
                                   dtlFuncDegreesList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    if( dtlDataTypeGroup[ aDataTypeArray[0] ] == DTL_GROUP_BINARY_INTEGER )
    {
        ...
        *aFuncResultDataType = DTL_TYPE_NATIVE_DOUBLE;
        ...
        /* function ptr idx 조정 */
        i = 0;
        while( dtlFuncDegreesList[i].mFuncPtr != NULL )
        {
            if( dtlFuncDegreesList[i].mFuncPtr == dtlDoubleDegrees )
            {
                break;
            }
            else
        ...
        STL_DASSERT( dtlFuncDegreesList[i].mFuncPtr == dtlDoubleDegrees );
        *aFuncPtrIdx = i;
    }
    else
    {
...
/**
 * @brief Degrees function pointer 얻기
                                ...
                                stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlDegrees가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncDegreesList[aFuncPtrIdx].mFuncPtr;
