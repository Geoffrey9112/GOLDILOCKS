...
/**
 * @file dtlFuncToNumber.c
 * @brief Data Type Layer To_Number 함수 
 */
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncToNumberInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncToNumberList[] =
{
    { dtlToNumber,
...
stlStatus dtlToNumber( stlUInt16        aInputArgumentCnt,
                       ...
                       void           * aEnv )
{
    return dtfToNumber( aInputArgumentCnt,
                        aInputArgument,
                        aResultValue,
                        aInfo,
                        aVectorFunc,
...
/**
 * @brief To_Number  function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncToNumberInfo,
                                   dtlFuncToNumberList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief To_Number function pointer 얻기
                                 ...
                                 stlErrorStack       * aErrorStack )
{
    ...
    *aFuncPtr = dtlFuncToNumberList[aFuncPtrIdx].mFuncPtr;
