/*******************************************************************************
 * dtlFuncToTimestampWithTimeZone.c
 *
...
/**
 * @file dtlFuncToTimestampWithTimeZone.c
 * @brief Data Type Layer To_Timestamp_with_time_zone 함수 
 */
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncToTimestampWithTimeZoneInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncToTimestampWithTimeZoneList[] =
{
    { dtlToTimestampWithTimeZone,
...
stlStatus dtlToTimestampWithTimeZone( stlUInt16        aInputArgumentCnt,
                                      ...
                                      void           * aEnv )
{
    return dtfToTimestampWithTimeZone( aInputArgumentCnt,
                                       aInputArgument,
                                       aResultValue,
                                       aInfo,
                                       aVectorFunc,
...
/**
 * @brief To_Timestamp_with_time_zone  function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncToTimestampWithTimeZoneInfo,
                                   dtlFuncToTimestampWithTimeZoneList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
...
/**
 * @brief To_Timestamp_with_time_zone function pointer 얻기
                                                ...
                                                stlErrorStack       * aErrorStack )
{
    ...
    *aFuncPtr = dtlFuncToTimestampWithTimeZoneList[aFuncPtrIdx].mFuncPtr;
