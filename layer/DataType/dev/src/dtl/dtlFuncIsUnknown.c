...
/**
 * @file dtlFuncIsUnknown.c
 * @brief Data Type Layer IS UNKNOWN 논리연산 
 */
...
/**
 * @brief IS UNKNOWN function에 대한 정보 얻기
...
/**
 * @brief IS UNKNOWN function pointer 얻기
