 ...
 *        $Id: dtlFuncRound.c 1841 2011-09-07 07:14:06Z jhkim $
 *
 * NOTES
 *
 *
 ...
 * 리턴한다.
 */
const dtlFuncInfo dtlFuncRoundInfo =
{
 ...
 */
const dtlFuncArgInfo dtlFuncRoundList[] =
{
     { dtlBigIntRound,
...
stlStatus dtlBigIntRound( stlUInt16        aInputArgumentCnt,
                          ...
                          void           * aEnv )
{
    return dtfBigIntRound( aInputArgumentCnt,
                           aInputArgument,
                           aResultValue,
                           aEnv );
}
...
stlStatus dtlNumericRound( stlUInt16        aInputArgumentCnt,
                           ...
                           void           * aEnv )
{
    return dtfNumericRound( aInputArgumentCnt,
                            aInputArgument,
                            aResultValue,
                            aEnv );
}
...
stlStatus dtlDoubleRound( stlUInt16        aInputArgumentCnt,
                          ...
                          void           * aEnv )
{
    return dtfDoubleRound( aInputArgumentCnt,
                           aInputArgument,
                           aResultValue,
                           aEnv );
}
...
stlStatus dtlDateRound( stlUInt16        aInputArgumentCnt,
                        ...
                        void           * aEnv )
{
    return dtfDateRound( aInputArgumentCnt,
                         aInputArgument,
                         aResultValue,
                         aInfo,
                         aVectorFunc,
...
/**
 * @brief Round function에 대한 정보 얻기
...
{
    STL_TRY( dtlGetFuncInfoCommon( &dtlFuncRoundInfo,
                                   dtlFuncRoundList,
                                   aDataTypeArrayCount,
                                   aIsConstantData,
                                   aDataTypeArray,
    ...
    /*
     * round( date[, 'fmt' ] ) 로,
     * round의 첫번째 인자로 date type만 가능하다.
     */
...
/**
 * @brief Round function pointer 얻기
                              ...
                              stlErrorStack       * aErrorStack )
{
    ...
    /*
     * dtlRound가 n차원 배열임으로 1차원 배열로 typecast해서
     * aFuncPtrIdx를 적용한다.
     */
    *aFuncPtr = dtlFuncRoundList[aFuncPtrIdx].mFuncPtr;
