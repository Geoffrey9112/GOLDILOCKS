 ...
 *        $Id: dtfTan.c 1296 2011-06-30 07:24:30Z ehpark $
 *
 * NOTES
...
/**
 * @file dtfTan.c
 * @brief dtfTan Function DataType Library Layer
 */
                        ...
                        void           * aEnv )
{
    ...
    /* tan 연산을 한다. */
    DTF_DOUBLE( sResultValue ) = stlTan( DTF_DOUBLE( sValue1 ) );
    sResultValue->mLength = DTL_NATIVE_DOUBLE_SIZE;

    /*
     *  tan 연산후 overflow또는 underflow가 났는지 확인한다.
     *
     */
