 ...
 *        $Id: dtfAtan.c 1296 2011-06-30 07:24:30Z ehpark $
 *
 * NOTES
...
/**
 * @file dtfAtan.c
 * @brief dtfAtan Function DataType Library Layer
 */
...
/*     /\* atan 연산을 한다. *\/ */
/*     sDouble = stlAtan( DTF_BIGINT( sValue1 ) ); */
                          ...
                          void           * aEnv )
{
    ...
    /* double -> numeric */
    STL_TRY( dtdToNumericFromFloat64( stlAtan( sDouble ),
                         ...
                         void           * aEnv )
{
    ...
    /* atan 연산을 한다. */
    DTF_DOUBLE( sResultValue ) = stlAtan( DTF_DOUBLE( sValue1 ) );
