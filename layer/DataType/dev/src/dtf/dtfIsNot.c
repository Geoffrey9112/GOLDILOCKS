...
/**
 * @file dtfIsNot.c
 * @brief dtfIsNot Function DataType Library Layer
 */
...
/**
 * @addtogroup dtfIsNot IS NOT
 * @ingroup dtf
 * @remark
 * <BR>  IS NOT의 boolean 연산은 아래와 같다.
 * <BR>  그러나, IS NOT(dtfIsNot) 함수로 들어오는 input argument로는 TRUE와 FALSE만 들어오고,
 * <BR>  UNKNOWN(null)인 경우는 상위 단계에서 처리된다. 
 * <BR>
 * <table>
 *   <tr> <td> IS NOT  </td> <td> TRUE  </td> <td> FALSE </td> <td> UNKNOWN </td> </tr>
 *   <tr> <td> TRUE    </td> <td> FALSE </td> <td> TRUE  </td> <td> TRUE    </td> </tr>
 *   <tr> <td> FALSE   </td> <td> TRUE  </td> <td> FALSE </td> <td> TRUE    </td> </tr>
 *   <tr> <td> UNKNOWN </td> <td> TRUE  </td> <td> TRUE  </td> <td> FALSE   </td> </tr>
 * </table>  
 * 
 * @internal
 * @{
...
/**
 * @brief boolean value의 IS NOT 연산
