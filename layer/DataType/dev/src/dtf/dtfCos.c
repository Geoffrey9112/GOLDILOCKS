 ...
 *        $Id: dtfCos.c 1296 2011-06-30 07:24:30Z ehpark $
 *
 * NOTES
...
/**
 * @file dtfCos.c
 * @brief dtfCos Function DataType Library Layer
 */
...
/*     /\* cos 연산을 한다. *\/ */
/*     sDouble = stlCos( DTF_BIGINT( sValue1 ) ); */
                         ...
                         void           * aEnv )
{
    ...
    /* double -> numeric */
    STL_TRY( dtdToNumericFromFloat64( stlCos( sDouble ),
                        ...
                        void           * aEnv )
{
    ...
    /* cos 연산을 한다. */
    DTF_DOUBLE( sResultValue ) = stlCos( DTF_DOUBLE( sValue1 ) );
