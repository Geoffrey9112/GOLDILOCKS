...
/**
 * @file dtfBitwiseOr.c
 * @brief dtfBitwiseOr Function DataType Library Layer
 */
...
/**
 * @addtogroup dtfBitwiseOr bitwiseOr
 * @ingroup dtf
 * @internal
 * @{
 */
...
/**
 * @brief integer(smallint/integer/bigint) value의 bitwise OR(|) 연산
 *        <BR> bitwise OR ( | )
 *        <BR>   | => [ P, M ]
 *        <BR> ex) 32 | 3  =>  35
 *
...
/**
 * @brief NUMBER value의 bitwise OR(|) 연산
 *        <BR> bitwise OR ( | )
 *        <BR>   | => [ P, M ]
 *        <BR> ex) 32 | 3  =>  35
 *
