...
/**
 * @file dtmTimeTz.c
 * @brief DataType Layer TimeTz(time with time zone) type의 비교 연산
 */
...
/**
 * @defgroup dtlTimeTz TimeTz Type간의 비교 연산
...
/**
 * @brief TimeTz vs TimeTz의 IsEqual 연산
                                        ...
                                        void           * aEnv )
{
    DTL_BOOLEAN( aResultValue ) =
        ((dtlTimeTzType *)aInputArgument[0].mValue.mDataValue->mValue)->mTime ==
        ((dtlTimeTzType *)aInputArgument[1].mValue.mDataValue->mValue)->mTime;
...
/**
 * @brief TimeTz vs TimeTz의 IsNotEqual 연산
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
...
/**
 * @brief TimeTz vs TimeTz의 IsLessThan 연산
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
...
/**
 * @brief TimeTz vs TimeTz의 IsLessThanEqual 연산
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
...
/**
 * @brief TimeTz vs TimeTz의 IsGreaterThan 연산
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
...
/**
 * @brief TimeTz vs TimeTz의 IsGreaterThanEqual 연산
 * @param[in]  aInputArgumentCnt input argument count
 * @param[in]  aInputArgument    input argument
