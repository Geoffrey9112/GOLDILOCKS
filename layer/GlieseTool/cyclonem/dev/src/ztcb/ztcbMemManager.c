                                  ...
                                  stlErrorStack * aErrorStack )
{
    ...
    else
    {
        ...
        STL_DASSERT( STL_RING_IS_EMPTY( &gSlaveMgr->mReadCkList ) == STL_FALSE );
                                     ...
                                     stlErrorStack * aErrorStack )
{
    ...
    else
    {
        ...
        STL_DASSERT( STL_RING_IS_EMPTY( &gSlaveMgr->mSubReadCkList ) == STL_FALSE );
                                      ...
                                      stlErrorStack * aErrorStack )
{
    ...
    else
    {
        ...
        STL_DASSERT( STL_RING_IS_EMPTY( &gSlaveMgr->mSubWriteCkList ) == STL_FALSE );
