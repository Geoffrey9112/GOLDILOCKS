                                 ...
                                 stlErrorStack * aErrorStack )
{
    ...
    STL_TRY( ztcaGetChunkItemToRead( aApplierMgr,
                                     &sChunkItem,
                                     aErrorStack ) == STL_SUCCESS );
//stlDebug("ztcaGetChunkItemToRead %ld, %ld, %ld \n", aSize, sChunkItem->mReadIdx, sChunkItem->mWriteIdx);
                                   ...
                                   stlErrorStack  * aErrorStack )
{
    ...
    if( STL_RING_IS_EMPTY( &aApplierMgr->mWriteCkList ) == STL_FALSE )
    {
        ...
        STL_DASSERT( sChunkItem->mBuffer != NULL );
    }
    else
    {
        ...
        STL_DASSERT( STL_RING_IS_EMPTY( &aApplierMgr->mWriteCkList ) == STL_FALSE );
                                  ...
                                  stlErrorStack  * aErrorStack )
{
    ...
    else
    {
        ...
        STL_DASSERT( STL_RING_IS_EMPTY( &aApplierMgr->mReadCkList ) == STL_FALSE );
                                            ...
                                            stlErrorStack * aErrorStack )
{
    ...
    if( STL_RING_IS_EMPTY( &aApplierMgr->mWriteCkList ) == STL_TRUE )
    {
        ztcmReleaseSpinLock( &(aApplierMgr->mWriteSpinLock) );
