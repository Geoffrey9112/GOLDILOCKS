...
stlStatus ztcbGetNextApplierMgr( ztcApplierMgr ** aApplierMgr )
{
    ...
    STL_ASSERT( gSlaveMgr->mCurApplierIdx < sApplierCount );
...
ztcApplierMgr * ztcbGetApplierMgr( stlInt32 aAppId )
{
    ...
    STL_ASSERT( aAppId < sApplierCount && 
                aAppId >= 0 );
