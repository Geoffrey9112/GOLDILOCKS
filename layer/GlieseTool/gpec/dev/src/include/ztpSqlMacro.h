...
#define STL_PARSER_START_TEXT____COMMAND_TERMINATOR( )      \
    {                                                       \
        stlChar  *sCopyStartPos;                            \
                                                            \
        sCopyStartPos = param->mBuffer + gSqlBufferIdx;     \
        stlStrncat( gSqlBuffer, sCopyStartPos,              \
                    a2 - gSqlBufferIdx + 1);                \
        gSqlBufferIdx = 0;                                  \
                                                            \
        param->mStmtLength = param->mCurrLoc;               \
        YYACCEPT;                                           \
    }                                                       \
...
#define STL_PARSER_COMMAND____EMPTY( )              \
    { param->mParseTree = ZTP_EMPTY_PARSE_TREE; }

#define STL_PARSER_COMMAND____ALTER_DATABASE( )                                 \
    {                                                                           \
        STL_PARSER_CHECK(                                                       \
            param->mParseTree = ztpMakeBypassSqlTree( param,                    \
                                                      ZLPL_STMT_ALTER,          \
                                                      ZTP_OBJECT_DATABASE ) );  \
    }
...
#define STL_PARSER_COMMAND____DECLARE_STATEMENT()               \
    {                                                           \
        STL_PARSER_CHECK(                                       \
            param->mParseTree = ztpMakeIgnoreStmt( param ) );   \
    }
...
#define STL_PARSER_UPDATE_STATEMENT_POSITIONED____CURSOR( )                     \
    {                                                                           \
        STL_PARSER_CHECK( v0 = ztpMakePositionedCursorDML( param,               \
                                                           v9,                  \
                                                           param->mBuffer ) );  \
    }
...
#define STL_PARSER_SIMPLE_VALUE_SPECIFICATION____HOST_PARAMETER( )  \
    {                                                               \
        STL_PARSER_CHECK( v0 = ztpAddHostVariable( param,           \
                                                   v1,              \
                                                   v2,              \
                                                   a1,              \
                                                   STL_TRUE ) );    \
...
#define STL_PARSER_SIGNED_NUMERIC_LITERAL____SIGNED_NUMERIC( )                  \
    {                                                                           \
        STL_PARSER_CHECK( v0 = ztpMakeSignedNumericString( param,               \
                                                           a1,                  \
                                                           param->mNextLoc ) ); \
    }
...
#define STL_PARSER_HOST_VARIABLE____()                                  \
    {                                                                   \
        stlInt32  sEndPos = 0;                                          \
        STL_PARSER_CHECK( v0 = ztpMakeHostVariableInSql( param,         \
                                                         a1,            \
                                                         &sEndPos) );   \
        yyclearin;                                                      \
        while( param->mNextLoc < sEndPos )                              \
        {                                                               \
            YYLEX;                                                      \
        }                                                               \
    }
...
#define STL_PARSER_REGUALAR_IDENTIFIER____ROWID_IDENTIFIER( )           \
    {                                                                   \
        STL_PARSER_CHECK( v0 = ztpMakeIdentifier( param, v1, a1 ) );    \
    }
...
#define STL_PARSER_INDICATOR_PARAMTER____EMPTY_INDICATOR( )                 \
    {                                                                       \
        STL_PARSER_CHECK( v0 = ztpMakeHostIndicator( param, v1, a1, a1 ) ); \
    }

#define STL_PARSER_INDICATOR_PARAMTER____INDICATOR( )                       \
    {                                                                       \
        STL_PARSER_CHECK( v0 = ztpMakeHostIndicator( param, v2, a1, a2 ) ); \
    }
...
#define STL_PARSER_COMMIT_STATEMENT____( )                  \
    {                                                       \
        STL_PARSER_CHECK(                                   \
            v0 = ztpMakeTransactionTree(param,              \
                                        ZLPL_STMT_COMMIT,   \
                                        STL_TRUE,           \
                                        STL_FALSE));        \
    }
...
#define STL_PARSER_DECLARE_CURSOR____ISO_TYPE()                                         \
    {                                                                                   \
        STL_PARSER_CHECK(                                                               \
            v0 = ztpMakeDeclareCursorISO( param,                                        \
                                          v2,                                           \
                                          (zlplCursorSensitivity)(stlVarInt)v3,         \
                                          (zlplCursorScrollability)(stlVarInt)v4,       \
                                          (zlplCursorHoldability)(stlVarInt)v6,         \
                                          v8) );                                        \
    }
...
#define STL_PARSER_DECLARE_CURSOR____ODBC_TYPE()                                        \
    {                                                                                   \
        STL_PARSER_CHECK(                                                               \
            v0 = ztpMakeDeclareCursorODBC( param,                                       \
                                           v2,                                          \
                                           (zlplCursorStandardType)(stlVarInt)v3,       \
                                           (zlplCursorHoldability)(stlVarInt)v5,        \
                                           v7) );                                       \
    }
...
#define STL_PARSER_DYNAMIC_CURSOR____ISO_TYPE()                                         \
    {                                                                                   \
        STL_PARSER_CHECK(                                                               \
            v0 = ztpMakeDynamicCursorISO( param,                                        \
                                          v2,                                           \
                                          (zlplCursorSensitivity)(stlVarInt)v3,         \
                                          (zlplCursorScrollability)(stlVarInt)v4,       \
                                          (zlplCursorHoldability)(stlVarInt)v6,         \
...
#define STL_PARSER_DYNAMIC_CURSOR____ODBC_TYPE()                                        \
    {                                                                                   \
        STL_PARSER_CHECK(                                                               \
            v0 = ztpMakeDynamicCursorODBC( param,                                       \
                                           v2,                                          \
                                           (zlplCursorStandardType)(stlVarInt)v3,       \
                                           (zlplCursorHoldability)(stlVarInt)v5,        \
                                           v7) );                                       \
...
#define STL_PARSER_CURSOR_SENSITIVITY____EMPTY()   \
    { v0 = (YYSTYPE)ZLPL_CURSOR_SENSITIVITY_NA; }

#define STL_PARSER_CURSOR_SENSITIVITY____INSENSITIVE()  \
    { v0 = (YYSTYPE)ZLPL_CURSOR_SENSITIVITY_INSENSITIVE; }

#define STL_PARSER_CURSOR_SENSITIVITY____SENSITIVE()  \
    { v0 = (YYSTYPE)ZLPL_CURSOR_SENSITIVITY_SENSITIVE; }

#define STL_PARSER_CURSOR_SENSITIVITY____ASENSITIVE()  \
    { v0 = (YYSTYPE)ZLPL_CURSOR_SENSITIVITY_ASENSITIVE; }
...
#define STL_PARSER_CURSOR_SCROLLABILITY____EMPTY()  \
    { v0 = (YYSTYPE)ZLPL_CURSOR_SCROLLABILITY_NA; }

#define STL_PARSER_CURSOR_SCROLLABILITY____NO_SCROLL()  \
    { v0 = (YYSTYPE)ZLPL_CURSOR_SCROLLABILITY_NO_SCROLL; }

#define STL_PARSER_CURSOR_SCROLLABILITY____SCROLL() \
    { v0 = (YYSTYPE)ZLPL_CURSOR_SCROLLABILITY_SCROLL; }
...
#define STL_PARSER_CURSOR_ODBC_TYPE____STATIC() \
    { v0 = (YYSTYPE)ZLPL_CURSOR_STANDARD_ODBC_STATIC; }

#define STL_PARSER_CURSOR_ODBC_TYPE____KEYSET() \
    { v0 = (YYSTYPE)ZLPL_CURSOR_STANDARD_ODBC_KEYSET; }

#define STL_PARSER_CURSOR_ODBC_TYPE____DYNAMIC() \
    { v0 = (YYSTYPE)ZLPL_CURSOR_STANDARD_ODBC_DYNAMIC; }
...
#define STL_PARSER_CURSOR_HOLDABILITY____EMPTY()  \
    { v0 = (YYSTYPE)ZLPL_CURSOR_HOLDABILITY_NA; }

#define STL_PARSER_CURSOR_HOLDABILITY____WITH_HOLD()  \
    { v0 = (YYSTYPE)ZLPL_CURSOR_HOLDABILITY_WITH_HOLD; }

#define STL_PARSER_CURSOR_HOLDABILITY____WITHOUT_HOLD()  \
    { v0 = (YYSTYPE)ZLPL_CURSOR_HOLDABILITY_WITHOUT_HOLD; }
...
#define STL_PARSER_OPEN_CURSOR____()                        \
    {                                                       \
        STL_PARSER_CHECK( v0 = ztpMakeOpenCursor( param,    \
                                                  v2,       \
                                                  NULL ) ); \
    }
...
#define STL_PARSER_CLOSE_CURSOR____()                       \
    {                                                       \
        STL_PARSER_CHECK( v0 = ztpMakeCloseCursor(param,    \
                                                  v2) );    \
    }
...
#define STL_PARSER_FETCH_ORIENTATION____EMPTY()             \
    {                                                       \
        STL_PARSER_CHECK(                                   \
            v0 = ztpMakeFetchOrientation( param,            \
                                          ZLPL_FETCH_NA,    \
                                          NULL,             \
                                          0,                \
                                          NULL ) );         \
...
#define STL_PARSER_FETCH_ORIENTATION____ABSOLUTE()                                      \
    {                                                                                   \
        ztpCVariable * sHostVar = ((ztpSqlParseParam*)(param->mContext))->mHostVarList; \
        ((ztpSqlParseParam*)(param->mContext))->mHostVarList = NULL;                    \
                                                                                        \
        if ( sHostVar != NULL )                                                         \
        {                                                                               \
            STL_PARSER_CHECK( v0 = ztpMakeFetchOrientation( param,                      \
                                                            ZLPL_FETCH_ABSOLUTE,        \
                                                            NULL,                       \
                                                            0,                          \
                                                            sHostVar ) );               \
...
#define STL_PARSER_CONNECT____USING()                   \
    {                                                   \
        STL_PARSER_CHECK(v0 = ztpSetConnectParam(param, \
                                                 v2,    \
                                                 NULL,  \
                                                 v4));  \
    }
...
#define STL_PARSER_USER_PWD____USER_PASSWORD_ALL()          \
    {                                                       \
        STL_PARSER_CHECK(v0 = ztpMakeConnectParam(param,    \
                                                  v1,       \
                                                  NULL));   \
    }
...
#define STL_PARSER_CONN_STRING_DESC____IDENTIFIER()                 \
    {                                                               \
        stlChar  *sLiteral = ztpMakeStaticConnStringInSql(param, v1);  \
                                                                    \
        STL_PARSER_CHECK(                                           \
            v0 = ztpMakeNameTag(param,                              \
...
#define STL_PARSER_DISCONNECT____EMPTY()                            \
    {                                                               \
        STL_PARSER_CHECK(v0 = ztpMakeDisconnectParam(param,         \
                                                     NULL,          \
                                                     STL_FALSE));   \
    }
...
#define STL_PARSER_EXECUTE_IMMEDIATE____HOSTVAR()                       \
    {                                                                   \
        ztpCVariable * sHostVar = NULL;                                 \
        STL_PARSER_CHECK( sHostVar = ztpAddHostVariable( param,         \
                                                         v3,            \
                                                         NULL,          \
                                                         a3,            \
                                                         STL_TRUE) );   \
                                                                        \
        ((ztpSqlParseParam*)(param->mContext))->mHostVarList = NULL;    \
        STL_PARSER_CHECK(v0 = ztpMakeExecuteImmediate( param,           \
                                                       STL_FALSE,       \
                                                       sHostVar,        \
                                                       NULL ));         \
    }
    ...
    {                                                                   \
        ...
        STL_PARSER_CHECK( sHostVar = ztpAddHostVariable( param,         \
                                                         ...
                                                         STL_TRUE ) );  \
                                                                        \
        ((ztpSqlParseParam*)(param->mContext))->mHostVarList = NULL;    \
        STL_PARSER_CHECK(v0 = ztpMakePrepare( param,                    \
                                              v2,                       \
                                              STL_FALSE,                \
                                              sHostVar,                 \
                                              NULL ));                  \
...
#define STL_PARSER_EXECUTE____EMPTY()                   \
    {                                                   \
        STL_PARSER_CHECK(v0 = ztpMakeExecute( param,    \
                                              v2,       \
                                              NULL,     \
                                              NULL ));  \
    }
...
#define STL_PARSER_USING_PARAMETER_CLAUSE____ARGUMENTS() \
    {                                                                                   \
        ...
        ((ztpSqlParseParam*)(param->mContext))->mHostVarList = NULL;                    \
                                                                                        \
        STL_PARSER_CHECK(v0 = ztpMakeDynamicParam( param,                               \
                                                   STL_FALSE,                           \
                                                   sHostVar,                            \
                                                   NULL ));                             \
    }
