...
#define ZTN_ERRCODE_INVALID_HOME                 STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 0 )
#define ZTN_ERRCODE_INVALID_FILE_NAME            STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 1 )
#define ZTN_ERRCODE_SERVICE_NOT_AVAILABLE        STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 2 )
#define ZTN_ERRCODE_CONFIGURE_FILE_PARSE         STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 3 )
#define ZTN_ERRCODE_DUPLICATE_GROUP_NAME         STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 4 )
#define ZTN_ERRCODE_INVALID_VALUE                STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 5 )
#define ZTN_ERRCODE_INVALID_GROUP_NAME           STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 6 )
#define ZTN_ERRCODE_INVALID_PORT                 STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 7 )
#define ZTN_ERRCODE_INVALID_GROUP_COUNT          STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 8 )
#define ZTN_ERRCODE_ALREADY_RUNNING              STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 9 )
#define ZTN_ERRCODE_COMMUNICATION_LINK_FAILURE   STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 10 )
#define ZTN_ERRCODE_PROTOCOL                     STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 11 )
#define ZTN_ERRCODE_ALREADY_CONN                 STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 12 )
#define ZTN_ERRCODE_NOT_RUNNING                  STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 13 )
#define ZTN_ERRCODE_INTERNAL_ERROR               STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 14 )
#define ZTN_ERRCODE_UPDATE_INFO_FAIL             STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 15 )
#define ZTN_ERRCODE_INVALID_CONN_INFO            STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 16 )
#define ZTN_ERRCODE_INVALID_LIB_VERSION          STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 17 )
#define ZTN_ERRCODE_ERROR_WRITE_FILE             STL_MAKE_ERRCODE( STL_ERROR_MODULE_GLIESE_TOOL_CYMONM, 18 )

#define ZTN_MAX_ERROR     19
...
#define ZTN_DEFAULT_CONFIGURE_FILE       "cyclonem.slave.conf"

#define ZTN_DEFAULT_PID_FILE             ".cymonm.pid"
...
#define ZTN_INFO_TABLE_NAME              "CYCLONEM_MONITOR_INFO"

#define ZTN_DEFAULT_LOG_BLOCK_SIZE       ( 512 )

#define ZTN_DEFAULT_MONITOR_CYCLE_MS     ( 2 * 1000 )

#define ZTN_DEFAULT_LIB_CONFIG           "lib.conf"

#define ZTN_DEFAULT_STATE_FILE           "state.dat"
/** @} */
...
typedef struct ztnConfigure
{
    ...
    stlChar        mStateFile[STL_MAX_FILE_PATH_LENGTH];
...
typedef struct ztnLibFunc
{
    ztclFuncGetVersion          mGetVersion;
    ztclFuncInitializeMonitor   mInitializeMonitor;
    ztclFuncGetState            mGetState;
    ztclFuncFinalizeMonitor     mFinalizeMonitor;
} ztnLibFunc;
