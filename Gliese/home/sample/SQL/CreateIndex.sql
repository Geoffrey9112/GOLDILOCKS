...
--###################################################
--# CREATE INDEX: with <LOGGING | NOLOGGING>
--###################################################
...
--# result: success
CREATE INDEX idx_t1_id ON t1( id ) LOGGING;
COMMIT;


--# result: success
CREATE INDEX idx_t1_name ON t1( name ) NOLOGGING;
COMMIT;
...
--# result: success
CREATE INDEX idx_t1_id ON t1( id ) LOGGING TABLESPACE mem_data_tbs;
COMMIT;


--# result: success
CREATE INDEX idx_t1_name ON t1( name ) NOLOGGING TABLESPACE mem_temp_tbs;
COMMIT;
