...
--#             Customer#3     32151.78
--#             Customer#5     144659.2
SELECT customer.c_name, o_totalprice FROM (customer INNER JOIN orders ON customer.c_custkey = orders.o_custkey);
...
--#             Customer#5     32151.78
--#             Customer#5     144659.2
SELECT c_name, o_totalprice FROM customer CROSS JOIN orders;
...
--#             Customer#3     32151.78
--#             Customer#5     144659.2
SELECT c_name, o_totalprice FROM customer INNER JOIN orders ON c_custkey = o_custkey;
...
--#             Customer#4    193846.25
--#             Customer#5     144659.2
SELECT c_name, o_totalprice FROM customer LEFT OUTER JOIN orders ON c_custkey = o_custkey AND o_orderdate < '1996-01-01';
...
--#             Customer#3     32151.78
--#             null           144659.2
SELECT c_name, o_totalprice FROM customer RIGHT OUTER JOIN orders ON c_custkey = o_custkey AND c_nation = 'KOREA';
...
--#             null          193846.25
--#             null           144659.2
SELECT c_name, o_totalprice FROM customer FULL OUTER JOIN orders ON c_custkey = o_custkey AND c_nation = 'KOREA' AND o_orderdate < '1996-01-01';
...
--#             Customer#3     32151.78
--#             Customer#5     144659.2
SELECT c_name, o_totalprice FROM (SELECT c_custkey custkey, c_name FROM customer) NATURAL JOIN (SELECT o_custkey custkey, o_totalprice FROM orders);
...
SELECT s_name, ps_availqty, ps_supplycost FROM supplier, partsupp WHERE s_nation = 'KOREA' AND s_suppkey = ps_suppkey;
